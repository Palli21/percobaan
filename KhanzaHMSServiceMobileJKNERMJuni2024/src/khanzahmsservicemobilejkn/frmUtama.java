                                        ...
                                        if(!datajam.equals("")){
                                            if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat_batal"),"99",datajam})==true){
                                                ...
                                                try {     
                                                    ...
                                                    TeksArea.append("respon WS BPJS : "+nameNode.path("code").asText()+" "+nameNode.path("message").asText()+"\n");
                                                    koneksibpjs.prepareStatement("insert into log_add_antrian values('0','"+rs.getString("tgl_registrasi")+"','"+rs.getString("nobooking")+"','batal','admin','"+utc+"','"+rs.getString("nm_pasien")+"','"+rs.getString("no_rawat")+"',"+
                                                    "'"+rs.getString("nm_poli")+"','"+root+"','"+nameNode.path("code").asText()+"','"+requestJson+"','"+headers+"','"+URL+"')").executeUpdate();
                                                }catch (Exception ex) {
                                                    System.out.println("Notifikasi Bridging : "+ex);
                                                }
                        ...
                        try {
                            ...
                            while(rs.next()){
                                ...
                                try {
                                    ...
                                    datajam=Sequel.cariIsi("SELECT concat(antriloketcetak.tanggal,' ',antriloketcetak.jam) FROM antriloketcetak INNER JOIN reg_periksa ON antriloketcetak.no_rawat = reg_periksa.no_rawat AND antriloketcetak.tanggal = reg_periksa.tgl_registrasi WHERE reg_periksa.no_rawat =?",rs.getString("no_rawat"));
                                    if(!datajam.equals("")){
                                ...
                                datajam=Sequel.cariIsi("SELECT concat(antriloketcetak.tanggal,' ',antriloketcetak.jampanggil) FROM antriloketcetak INNER JOIN reg_periksa ON antriloketcetak.no_rawat = reg_periksa.no_rawat AND antriloketcetak.tanggal = reg_periksa.tgl_registrasi WHERE reg_periksa.no_rawat =?",rs.getString("no_rawat"));
                                if(!datajam.equals("")){
