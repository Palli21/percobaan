...
public class DlgBarang extends javax.swing.JDialog {
    ...
    public DlgBarang(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,new Object[]{
            ...
            "Kode Golongan","Golongan","Tipe Barang","Jenis Penerimaan"
        }) {
            @Override
    ...
    private void initComponents() {
        ...
        label42.setText("Tipe :");
        label42.setName("label42"); // NOI18N
        label42.setPreferredSize(new java.awt.Dimension(40, 23));
        panelisi2.add(label42);

        cmbTipeCari = new widget.ComboBox();
        cmbTipeCari.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "SEMUA", "OBAT", "BHP" }));
        cmbTipeCari.setSelectedIndex(0);
        cmbTipeCari.setName("cmbTipeCari"); // NOI18N
        cmbTipeCari.setPreferredSize(new java.awt.Dimension(100, 23));
        cmbTipeCari.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbTipeCariActionPerformed(evt);
            }
        });
        panelisi2.add(cmbTipeCari);
        ...
        label41.setText("Tipe Barang :");
        label41.setName("label41"); // NOI18N
        label41.setPreferredSize(new java.awt.Dimension(65, 23));
        FormInput.add(label41);
        label41.setBounds(760, 12, 88, 23);

        TipeBarang = new widget.ComboBox();
        TipeBarang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "OBAT", "BHP" }));
        TipeBarang.setName("TipeBarang"); // NOI18N
        TipeBarang.setPreferredSize(new java.awt.Dimension(62, 23));
        FormInput.add(TipeBarang);
        TipeBarang.setBounds(850, 12, 110, 23);

        label43 = new widget.Label();
        label43.setText("Jenis Penerimaan :");
        label43.setName("label43"); // NOI18N
        label43.setPreferredSize(new java.awt.Dimension(65, 23));
        FormInput.add(label43);
        label43.setBounds(730, 42, 120, 23);

        JenisPenerimaan = new widget.ComboBox();
        JenisPenerimaan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "BLUD", "IFDK", "BKKBN", "APBD", "PEMASUKAN LAIN-LAIN" }));
        JenisPenerimaan.setName("JenisPenerimaan"); // NOI18N
        JenisPenerimaan.setPreferredSize(new java.awt.Dimension(62, 23));
        FormInput.add(JenisPenerimaan);
        JenisPenerimaan.setBounds(850, 42, 170, 23);
    ...
    private void cmbTipeCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbTipeCariActionPerformed
        if(akses.getform().equals("tampil3")){
            tampil3();
        }else{
            tampil();
        }
    }//GEN-LAST:event_cmbTipeCariActionPerformed
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().equals("")) {
            ...
            if(Valid.editTabletf(tabMode, "databarang", "kode_brng", "?", "nama_brng=?,kode_brng=?,kapasitas=?,kode_sat=?,letak_barang=?,"
                    ...
                    + "karyawan=?,expire=?,kode_industri=?,kode_kategori=?,kode_golongan=?,type_barang=?,jenis_penerimaan=?,kode_satbesar=?,dasar=?,isi=?", 28, new String[]{
                        ...
                        kdkategori.getText(),kdgolongan.getText(),TipeBarang.getSelectedItem().toString(),JenisPenerimaan.getSelectedItem().toString(),kdsatBesar.getText(),dasar.getText(),Isi.getText(),
                ...
                tbObat.setValueAt(TipeBarang.getSelectedItem().toString(),tbObat.getSelectedRow(),32);
                tbObat.setValueAt(JenisPenerimaan.getSelectedItem().toString(),tbObat.getSelectedRow(),33);
                emptTeks();
            }
        }
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptBarang.jasper", "report", "::[ Data Barang ]::", 
                        ...
                        + " databarang.kode_kategori,kategori_barang.nama as kategori,databarang.kode_golongan,golongan_barang.nama as golongan,databarang.type_barang,databarang.jenis_penerimaan "
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Kd.getText().trim().equals("")) {
            ...
            if(Sequel.menyimpantf("databarang", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Kode Barang", 28, new String[]{
                    ...
                    KdIF.getText(),kdkategori.getText(),kdgolongan.getText(),TipeBarang.getSelectedItem().toString(),JenisPenerimaan.getSelectedItem().toString()
                })==true){
                tabMode.addRow(new Object[]{
                    ...
                    TipeBarang.getSelectedItem().toString(),JenisPenerimaan.getSelectedItem().toString()
                });
                LCount.setText("" + tabMode.getRowCount());
                emptTeks();
            }
...
private void KapasitasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KapasitasKeyPressed
    ...
    private widget.ComboBox TipeBarang;
    private widget.ComboBox JenisPenerimaan;
    private widget.ComboBox cmbTipeCari;
        ...
        if(aktifkanbatch.equals("no")){
            try {
                ...
                try {
                    ...
                    rs = ps.executeQuery();
                    String filterTipe = cmbTipeCari.getSelectedItem().toString();
                    boolean semuaTipe = filterTipe.equals("SEMUA");
                    while (rs.next()) {
                        String tipeBarang = rs.getString("type_barang");
                        if(!semuaTipe && !filterTipe.equalsIgnoreCase(tipeBarang)){
                            continue;
                        }
                        tabMode.addRow(new Object[]{
                            ...
                            rs.getString("type_barang"),
                            rs.getString("jenis_penerimaan")
                        });
                    }
                    LCount.setText("" + tabMode.getRowCount());
                } catch (Exception e) {
            ...
            try {
                ps = koneksi.prepareStatement(
                    ...
                    + " databarang.kode_kategori,kategori_barang.nama as kategori,databarang.kode_golongan,golongan_barang.nama as golongan,databarang.type_barang,databarang.jenis_penerimaan,data_batch.no_batch,data_batch.no_faktur "
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    try {
                        ...
                        tabMode.addRow(new Object[]{false, "", "  Total Stok", ": " + totalstok, "", null,null,null,null,null, null, null, null, null, null, null, null, null, null, null, null, null,null, null,null,null,null,null,null,null,null,null,null,null});
                    } catch (Exception e) {
                        System.out.println("Notifikasi : " + e);
                    } finally{
                        if(rs2 != null){
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    try {
                        ...
                        tabMode.addRow(new Object[]{false, "","    "+nmlokasi, ": " + stokgudang, "", null,null,null,null,null, null, null, null, null, null, null, null, null, null, null, null,null,null, null,null,null,null,null,null,null,null,null,null,null});
                    } catch (Exception e) {
                        System.out.println("Notifikasi : " + e);
                    } finally{
                        if(rs3 != null){
    ...
    public void emptTeks() {
        ...
        kdgolongan.setText("");
        nmgolongan.setText("");
        TipeBarang.setSelectedItem("OBAT");
        JenisPenerimaan.setSelectedItem("BLUD");
    ...
    private void getData() {
        ...
        if (row != -1) {
            ...
            if(tbObat.getValueAt(row, 32)!=null){
                TipeBarang.setSelectedItem(tbObat.getValueAt(row, 32).toString());
            }else{
                TipeBarang.setSelectedIndex(0);
            }
            if(tbObat.getValueAt(row, 33)!=null){
                JenisPenerimaan.setSelectedItem(tbObat.getValueAt(row, 33).toString());
            }else{
                JenisPenerimaan.setSelectedIndex(0);
            }
    ...
    public void isBatch(){
        tabMode = new DefaultTableModel(null,new Object[]{
                ...
                "Kelas Utama/BPJS(Rp)", "Ranap VIP(Rp)", "Ranap VVIP(Rp)", "Beli Luar(Rp)","Jual Bebas(Rp)", "Karyawan(Rp)", 
                "Stok Min", "Kode Jenis", "Nama Jenis","Kadaluwarsa","Kode I.F.","Industri Farmasi","Kode Kategori","Kategori",
                "Kode Golongan","Golongan","Tipe Barang","Jenis Penerimaan","No.Batch","No.Faktur"
            }) {
                @Override
                public boolean isCellEditable(int rowIndex, int colIndex) {
                    boolean a = false;
