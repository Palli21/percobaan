...
public class DlgCariPengeluaranApotek extends javax.swing.JDialog {
    ...
    public DlgCariPengeluaranApotek(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                "No.Keluar","Tanggal","Keterangan","Lokasi","Petugas","Type Pengeluaran","Jenis Penerimaan","Harga","Jml","Total"
            }){
        ...
        tabMode2=new DefaultTableModel(null,new Object[]{
                "No.Keluar","Tanggal","Keterangan","Asal Stok","Petugas","Type Pengeluaran","Jenis Penerimaan","Kode Barang","Nama Barang","Jenis","Satuan","No.Batch","No.Faktur","Harga","Jml","Total"
            }){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
    ...
    private void initComponents() {
        ...
        CmbJenisPenerimaan = new widget.ComboBox();
        CmbTypePengeluaran = new widget.ComboBox();
        ...
        label16.setText("Jenis Penerimaan :");
        label16.setName("label16"); // NOI18N
        label16.setPreferredSize(new java.awt.Dimension(60, 23));
        panelisi3.add(label16);
        label16.setBounds(810, 40, 100, 23);
        ...
        CmbJenisPenerimaan.setName("CmbJenisPenerimaan"); // NOI18N
        CmbJenisPenerimaan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CmbJenisPenerimaanActionPerformed(evt);
            }
        });
        panelisi3.add(CmbJenisPenerimaan);
        CmbJenisPenerimaan.setBounds(920, 40, 170, 20);

        CmbTypePengeluaran.setName("CmbTypePengeluaran"); // NOI18N
        panelisi3.add(CmbTypePengeluaran);
        CmbTypePengeluaran.setBounds(920, 10, 170, 20);

        label19.setText("Bangsal :");
        label19.setName("label19"); // NOI18N
        label19.setPreferredSize(new java.awt.Dimension(60, 23));
        panelisi3.add(label19);
        label19.setBounds(385, 10, 60, 23);

        label20.setText("Type Pengeluaran :");
        label20.setName("label20"); // NOI18N
        label20.setPreferredSize(new java.awt.Dimension(60, 23));
        panelisi3.add(label20);
        label20.setBounds(810, 10, 100, 23);
...
*/
    ...
    private void BtnAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAllActionPerformed
        ...
        kdptg.setText("");
        nmptg.setText("");
        if(CmbTypePengeluaran.getItemCount()>0){
            CmbTypePengeluaran.setSelectedIndex(0);
        }
        if(CmbJenisPenerimaan.getItemCount()>0){
            CmbJenisPenerimaan.setSelectedIndex(0);
        }
        if(TabRawat.getSelectedIndex()==0){
            tampil();
        }else if(TabRawat.getSelectedIndex()==1){
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(TabRawat.getSelectedIndex()==0){
            if(tabMode.getRowCount()==0){
                ...
                for(i=0;i<row;i++){  
                    Sequel.menyimpan("temporary","'"+i+"','"+
                                    ...
                                    tabMode.getValueAt(i,9).toString()+"','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getalamatip()+"'","Transaksi Stok Keluar"); 
                }
                i++;
            ...
            if(tabMode2.getRowCount()==0){
                ...
                String tipePengeluaran = (CmbTypePengeluaran.getSelectedItem()==null?"":CmbTypePengeluaran.getSelectedItem().toString().trim());
                String jenisPenerimaan = (CmbJenisPenerimaan.getSelectedItem()==null?"":CmbJenisPenerimaan.getSelectedItem().toString().trim());
                ...
                if(!tipePengeluaran.equals("")){
                    jen=jen+" and ifnull(databarang.type_barang,'') like '%"+tipePengeluaran+"%' ";
                }
                if(!jenisPenerimaan.equals("")){
                    bar=bar+" and ifnull(databarang.jenis_penerimaan,'') like '%"+jenisPenerimaan+"%' ";
                }
                ...
                Valid.MyReportqry("rptStokKeluarMedis2.jasper","report","::[ Data Stok Keluar Obat, Alkes & BHP ]::",
                    ...
                    "pengeluaran_obat_bhp.kd_bangsal,bangsal.nm_bangsal,pengeluaran_obat_bhp.keterangan,ifnull(databarang.type_barang,'') as type_pengeluaran,ifnull(databarang.jenis_penerimaan,'') as jenis_penerimaan,detail_pengeluaran_obat_bhp.kode_brng,"+
...
private void ppHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusActionPerformed
    ...
    private void CmbJenisPenerimaanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CmbJenisPenerimaanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_CmbJenisPenerimaanActionPerformed
    ...
    */
    ...
    private widget.ComboBox CmbJenisPenerimaan;
    private widget.ComboBox CmbTypePengeluaran;
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    ...
                    "pengeluaran_obat_bhp.nip,petugas.nama, ifnull(databarang.type_barang,'') as type_pengeluaran, "+
                    "pengeluaran_obat_bhp.kd_bangsal,bangsal.nm_bangsal, ifnull(databarang.jenis_penerimaan,'') as jenis_penerimaan, "+
            ...
            try {
                ...
                while(rs.next()){     
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("type_pengeluaran"),rs.getString("jenis_penerimaan"),"","",""
                    });
                    tabMode.addRow(new String[]{
                        "","No.Batch & Faktur","Barang","Jenis","Satuan","Type Pengeluaran","Jenis Penerimaan","Harga","Jml","Total"
                    });
                    ps2=koneksi.prepareStatement(
                    " select detail_pengeluaran_obat_bhp.kode_brng,databarang.nama_brng,detail_pengeluaran_obat_bhp.no_faktur,"+
                            " jenis.nama,detail_pengeluaran_obat_bhp.harga_beli,detail_pengeluaran_obat_bhp.jumlah, ifnull(databarang.jenis_penerimaan,'') as jenis_penerimaan, "+
                            " ifnull(databarang.type_barang,'') as type_pengeluaran, detail_pengeluaran_obat_bhp.kode_sat,detail_pengeluaran_obat_bhp.no_batch,detail_pengeluaran_obat_bhp.total from "+
                    ...
                    try {
                        ...
                        while(rs2.next()){
                            ...
                            tabMode.addRow(new String[]{
                                ...
                                rs2.getString("nama"),rs2.getString("kode_sat"),rs2.getString("type_pengeluaran"), rs2.getString("jenis_penerimaan"),df2.format(rs2.getDouble("harga_beli")),
    ...
    private void loadTypePengeluaran(){
        CmbTypePengeluaran.removeAllItems();
        HashSet<String> sudah=new HashSet<>();
        String[] preset={"","OBAT","BHP"};
        for(String val:preset){
            CmbTypePengeluaran.addItem(val);
            sudah.add(val);
        }
        PreparedStatement psLoad=null;
        ResultSet rsLoad=null;
        try{
            psLoad=koneksi.prepareStatement("select distinct ifnull(type_barang,'') from databarang order by type_barang");
            rsLoad=psLoad.executeQuery();
            while(rsLoad.next()){
                String val=rsLoad.getString(1);
                if(val!=null){
                    val=val.trim();
                    if(!val.equals("") && sudah.add(val)){
                        CmbTypePengeluaran.addItem(val);
                    }
                }
            }
        }catch(Exception e){
            System.out.println("Notif loadTypePengeluaran : "+e);
        }finally{
            try{
                if(rsLoad!=null){
                    rsLoad.close();
                ...
                System.out.println("Notif loadTypePengeluaran close : "+e);
            }
        }
        if(CmbTypePengeluaran.getItemCount()>0){
            CmbTypePengeluaran.setSelectedIndex(0);
    ...
    private void loadJenisPenerimaan(){
        CmbJenisPenerimaan.removeAllItems();
        HashSet<String> sudah=new HashSet<>();
        String[] preset={"","BLUD","IFDK","BKKBN","APBD","PEMASUKAN LAIN-LAIN"};
        for(String val:preset){
            CmbJenisPenerimaan.addItem(val);
            sudah.add(val);
        }
        PreparedStatement psLoad=null;
        ResultSet rsLoad=null;
        try{
            psLoad=koneksi.prepareStatement("select distinct ifnull(jenis_penerimaan,'') from databarang order by jenis_penerimaan");
            rsLoad=psLoad.executeQuery();
            while(rsLoad.next()){
                String val=rsLoad.getString(1);
                if(val!=null){
            ...
            System.out.println("Notif loadJenisPenerimaan : "+e);
        }finally{
            try{
                if(rsLoad!=null){
                    rsLoad.close();
                ...
                System.out.println("Notif loadJenisPenerimaan close : "+e);
            }
        }
        if(CmbJenisPenerimaan.getItemCount()>0){
            CmbJenisPenerimaan.setSelectedIndex(0);
