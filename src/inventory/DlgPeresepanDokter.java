...
public final class DlgPeresepanDokter extends javax.swing.JDialog {
    ...
    public DlgPeresepanDokter(java.awt.Frame parent, boolean modal) {
        ...
        TNoRM.getDocument().addDocumentListener(new javax.swing.event.DocumentListener() {
            ...
            private void muat() {
                if (TNoRM.getText().trim().length() > 0) {
                    tampilRiwayatObatByNoRM(TNoRM.getText().trim());
                } else {
                    LoadHTMLRiwayatObat.setText("<html><body><i>Masukkan No. RM untuk melihat riwayat obat.</i></body></html>");
                }
            }
        ...
        for (i = 0; i < 12; i++) {
            ...
            if (i == 0) {
                ...
                column.setPreferredWidth(130);
            } else if (i == 3) { // Kode Barang -> sembunyikan
                column.setMinWidth(0);
                column.setMaxWidth(0);
                ...
                column.setPreferredWidth(240);
            } else if (i == 5) { // Satuan -> sembunyikan
                column.setMinWidth(0);
                column.setMaxWidth(0);
                column.setPreferredWidth(0);
                column.setResizable(false);
            } else if (i == 6) { // Komposisi -> sembunyikan
                column.setMinWidth(0);
                column.setMaxWidth(0);
                column.setPreferredWidth(0);
                column.setResizable(false);
            } else if (i == 7) { // Harga(Rp) -> sembunyikan
                column.setMinWidth(0);
                column.setMaxWidth(0);
                column.setPreferredWidth(0);
                column.setResizable(false);
                ...
                column.setPreferredWidth(110);
            } else if (i == 9) { // I.F. -> sembunyikan
                column.setMinWidth(0);
                column.setMaxWidth(0);
                column.setPreferredWidth(0);
                column.setResizable(false);
            } else if (i == 10) { // H.Beli -> sembunyikan
                column.setMinWidth(0);
                column.setMaxWidth(0);
                column.setPreferredWidth(0);
                column.setResizable(false);
    ...
    private void initComponents() {
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-11-2025" }));
        ...
        lblTemplate.setBounds(10, 210, 130, 23);
        ...
        ChkTemplate.setBounds(140, 210, 23, 23);
        ...
        NamaTemplate.setBounds(170, 210, 500, 23);

        BtnSimpan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/pills-5-32x32.png"))); // NOI18N
        BtnSimpan.setMnemonic('S');
        BtnSimpan.setText("Kirim Resep ke Apotik");
        BtnSimpan.setToolTipText("Alt+S");
        BtnSimpan.setGlassColor(new java.awt.Color(0, 102, 153));
        ...
        BtnSimpan.setBounds(10, 100, 190, 30);
...
// panggil handler tab bila memang Anda pakai pola ini
        TabRawatMouseClicked(null);

        // tetap kosongkan isian obat hanya saat tidak sedang ubah
        if (!ubah) {
            emptTeksobat();
        }

        // refresh panel riwayat kanan setiap form aktif
        if (TNoRM.getText().trim().length() > 0) {
            tampilRiwayatObatByNoRM(TNoRM.getText().trim());
        } else {
            LoadHTMLRiwayatObat.setText("<html><body><i>Masukkan No. RM untuk melihat riwayat obat.</i></body></html>");
    ...
    // --- Riwayat Obat (panel kanan)
    private widget.editorpane LoadHTMLRiwayatObat;
    private widget.ScrollPane  ScrollRiwayatObat;
    private HTMLEditorKit      kitObat;
    ...
    public void setNoRm(String norwt, String KodeDokter, String NamaDokter, String Pasien, String kodepj, String status) {
        ...
        // === PERBAIKAN: isi TNoRM & TglLahir berdasar no_rawat ===
        TNoRM.setText(Sequel.cariIsi(
                "select reg_periksa.no_rkm_medis from reg_periksa where reg_periksa.no_rawat=?", norwt
        ));
        Sequel.cariIsi(
                "select DATE_FORMAT(pasien.tgl_lahir,'%d-%m-%Y') as tgl_lahir from pasien where no_rkm_medis=?",
                TglLahir, TNoRM.getText()
        );

        // Isi tampilan pasien apa adanya dari parameter (Anda memang kirim 'no_rm + spasi + nama')
    ...
    private void tampilRiwayatObatByNoRM(String noRM) {
        // HTML builder
        ...
        LoadHTMLRiwayatObat.setText(html.toString());
        LoadHTMLRiwayatObat.setCaretPosition(0);
    }
