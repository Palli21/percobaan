...
public final class DlgStokOpname extends javax.swing.JDialog {
    ...
    public DlgStokOpname(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={
            "Kode Barang","Nama Barang","Type Barang","Jenis Penerimaan","Harga Beli","Satuan","Tanggal","Stok","Real","Selisih","Lebih","Total Real",
    ...
    private void initComponents() {
        ...
        JnsPenerimaan = new widget.ComboBox();
        label26 = new widget.Label();
        CmbTypeBarang = new widget.ComboBox();
        label25.setText("Jenis Penerimaan :");
        label25.setName("label25"); // NOI18N
        label25.setPreferredSize(new java.awt.Dimension(120, 23));
        panelBiasa1.add(label25);

        JnsPenerimaan.setName("JnsPenerimaan"); // NOI18N
        JnsPenerimaan.setPreferredSize(new java.awt.Dimension(170, 23));
        panelBiasa1.add(JnsPenerimaan);

        label26.setText("Type Barang :");
        label26.setName("label26"); // NOI18N
        label26.setPreferredSize(new java.awt.Dimension(95, 23));
        panelBiasa1.add(label26);

        CmbTypeBarang.setName("CmbTypeBarang"); // NOI18N
        CmbTypeBarang.setPreferredSize(new java.awt.Dimension(120, 23));
        panelBiasa1.add(CmbTypeBarang);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tbKamar.getRowCount()==0){
            ...
            String jenisPenerimaanDipilih = (JnsPenerimaan.getSelectedItem()==null?"":JnsPenerimaan.getSelectedItem().toString().trim());
            String typeBarangDipilih = (CmbTypeBarang.getSelectedItem()==null?"":CmbTypeBarang.getSelectedItem().toString().trim());
            if(nmjns.getText().equals("")&&nmkategori.getText().equals("")&&nmgolongan.getText().equals("")&&NmGudang.getText().equals("")&&jenisPenerimaanDipilih.equals("")&&typeBarangDipilih.equals("")&&TCari.getText().equals("")){
                Valid.MyReportqry("rptOpname.jasper","report","::[ Stok Opname ]::",
                    "select opname.kode_brng, databarang.nama_brng,ifnull(databarang.type_barang,'') as type_barang,ifnull(databarang.jenis_penerimaan,'') as jenis_penerimaan,opname.h_beli, databarang.kode_sat, opname.tanggal, opname.stok, "+
                ...
                Valid.MyReportqry("rptOpname.jasper","report","::[ Stok Opname ]::",
                     ...
                     "and ifnull(databarang.type_barang,'') like '%"+typeBarangDipilih+"%' "+
                     "and ifnull(databarang.jenis_penerimaan,'') like '%"+jenisPenerimaanDipilih+"%' "+
                     ...
                     "opname.keterangan like '%"+TCari.getText().trim()+"%' or ifnull(databarang.type_barang,'') like '%"+TCari.getText().trim()+"%' or "+
                     "ifnull(databarang.jenis_penerimaan,'') like '%"+TCari.getText().trim()+"%') order by opname.tanggal",param);
            }
    ...
    private void BtnAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAllActionPerformed
        ...
        nmjns.setText("");
        nmkategori.setText("");
        if(JnsPenerimaan.getItemCount()>0){
            JnsPenerimaan.setSelectedIndex(0);
        }
        if(CmbTypeBarang.getItemCount()>0){
            CmbTypeBarang.setSelectedIndex(0);
        }
        kdgolongan.setText("");
        kdjenis.setText("");
        kdkategori.setText("");
...
private void StokKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_StokKeyPressed
    ...
    */
    ...
    private widget.ComboBox CmbTypeBarang;
    private widget.ComboBox JnsPenerimaan;
    ...
    private void tampil() {
        ...
        try{     
            if(nmjns.getText().equals("")&&nmkategori.getText().equals("")&&nmgolongan.getText().equals("")&&NmGudang.getText().equals("")&&jenisPenerimaanDipilih.equals("")&&typeBarangDipilih.equals("")&&TCari.getText().equals("")){
                pstampil=koneksi.prepareStatement("select opname.kode_brng, databarang.nama_brng,ifnull(databarang.type_barang,'') as type_barang,ifnull(databarang.jenis_penerimaan,'') as jenis_penerimaan,opname.h_beli, databarang.kode_sat, opname.tanggal, opname.stok, "+
                     "opname.real, opname.selisih, opname.lebih, (opname.real*opname.h_beli) as totalreal,opname.nomihilang,opname.nomilebih, opname.keterangan, bangsal.kd_bangsal, bangsal.nm_bangsal, "+
                     "opname.no_batch,opname.no_faktur from opname inner join databarang on opname.kode_brng=databarang.kode_brng "+
                     "inner join bangsal on opname.kd_bangsal=bangsal.kd_bangsal "+
                     "inner join jenis on databarang.kdjns=jenis.kdjns "+
                ...
                pstampil=koneksi.prepareStatement("select opname.kode_brng, databarang.nama_brng,ifnull(databarang.type_barang,'') as type_barang,ifnull(databarang.jenis_penerimaan,'') as jenis_penerimaan,opname.h_beli, databarang.kode_sat, opname.tanggal, opname.stok, "+
                     ...
                     "inner join kategori_barang on databarang.kode_kategori=kategori_barang.kode "+
                     "inner join golongan_barang on databarang.kode_golongan=golongan_barang.kode where "+
                     "opname.tanggal between ? and ? and concat(databarang.kdjns,jenis.nama) like ? and concat(databarang.kode_kategori,kategori_barang.nama) like ? and concat(databarang.kode_golongan,golongan_barang.nama) like ? and concat(bangsal.kd_bangsal,bangsal.nm_bangsal) like ? and ifnull(databarang.type_barang,'') like ? and ifnull(databarang.jenis_penerimaan,'') like ? and "+
                     "(opname.kode_brng like ? or databarang.nama_brng like ? or opname.kode_brng like ? or bangsal.kd_bangsal like ? or bangsal.nm_bangsal like ? or databarang.kode_sat like ? or opname.keterangan like ? or ifnull(databarang.type_barang,'') like ? or ifnull(databarang.jenis_penerimaan,'') like ?) order by opname.tanggal");
            }
            ...
            try {     
                if(nmjns.getText().equals("")&&nmkategori.getText().equals("")&&nmgolongan.getText().equals("")&&NmGudang.getText().equals("")&&jenisPenerimaanDipilih.equals("")&&typeBarangDipilih.equals("")&&TCari.getText().equals("")){
                    ...
                    pstampil.setString(7,"%"+typeBarangDipilih+"%");
                    pstampil.setString(8,"%"+jenisPenerimaanDipilih+"%");
                    ...
                    pstampil.setString(17,"%"+TCari.getText().trim()+"%");
                }
                    
                rstampil=pstampil.executeQuery();
                while(rstampil.next()){                
                    totalreal=totalreal+rstampil.getDouble(12); 
                    total=total+rstampil.getDouble(13);
                    totallebih=totallebih+rstampil.getDouble(14);
                    tabMode.addRow(new Object[]{
                        rstampil.getString(1),rstampil.getString(2),rstampil.getString(3),rstampil.getString(4),df2.format(rstampil.getDouble(5)),
                        rstampil.getString(6),rstampil.getString(7),rstampil.getString(8),rstampil.getString(9),rstampil.getString(10),
                        rstampil.getString(11),df2.format(rstampil.getDouble(12)),df2.format(rstampil.getDouble(13)),
                        df2.format(rstampil.getDouble(14)),rstampil.getString(15),rstampil.getString(16),rstampil.getString(17),
                        rstampil.getString(18),rstampil.getString(19)
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        ...
        if(row!= -1){
            ...
            Stok.setText(tbKamar.getValueAt(row,7).toString());
            Real.setText(tbKamar.getValueAt(row,8).toString());            
            Selisih.setText(tbKamar.getValueAt(row,9).toString());        
            Lebih.setText(tbKamar.getValueAt(row,10).toString());      
            TotalReal.setText(tbKamar.getValueAt(row,11).toString());          
            Nominal.setText(tbKamar.getValueAt(row,12).toString());   
            NomiLebih.setText(tbKamar.getValueAt(row,13).toString());            
            Keterangan.setText(tbKamar.getValueAt(row,14).toString());   
            kdgudang.setText(tbKamar.getValueAt(row,15).toString());   
            nmgudang.setText(tbKamar.getValueAt(row,16).toString());   
            nobatch.setText(tbKamar.getValueAt(row,17).toString());  
            nofaktur.setText(tbKamar.getValueAt(row,18).toString());      
            Valid.SetTgl(Tanggal,tbKamar.getValueAt(row,6).toString());
        }
    }
    ...
    private void loadJenisPenerimaan(){
        JnsPenerimaan.removeAllItems();
        HashSet<String> sudahAda=new HashSet<>();
        JnsPenerimaan.addItem("");
        String[] preset={"BLUD","IFDK","BKKBN","APBD","PEMASUKAN LAIN-LAIN"};
        for(String val:preset){
            JnsPenerimaan.addItem(val);
            sudahAda.add(val);
        }
        PreparedStatement ps=null;
        ResultSet rs=null;
        try{
            ps=koneksi.prepareStatement("select distinct ifnull(jenis_penerimaan,'') from databarang order by jenis_penerimaan");
            rs=ps.executeQuery();
            while(rs.next()){
                String jp=rs.getString(1);
                if(jp!=null){
                    jp=jp.trim();
                    if(!jp.equals("") && sudahAda.add(jp)){
                        JnsPenerimaan.addItem(jp);
                    }
                }
            }
        }catch(Exception e){
            System.out.println("Notif jenis_penerimaan : "+e);
        }finally{
            try{
                if(rs!=null){
                    rs.close();
                ...
                System.out.println("Notif jenis_penerimaan close : "+e);
            }
        }
        if(JnsPenerimaan.getItemCount()>0){
            JnsPenerimaan.setSelectedIndex(0);
    ...
    private void loadTypeBarang(){
        CmbTypeBarang.removeAllItems();
        HashSet<String> sudahAda=new HashSet<>();
        String[] preset={"","OBAT","BHP"};
        for(String val:preset){
            CmbTypeBarang.addItem(val);
            sudahAda.add(val);
        }
        PreparedStatement ps=null;
        ResultSet rs=null;
        try{
            ps=koneksi.prepareStatement("select distinct ifnull(type_barang,'') from databarang order by type_barang");
            rs=ps.executeQuery();
            while(rs.next()){
                String tp=rs.getString(1);
                if(tp!=null){
                    tp=tp.trim();
                    if(!tp.equals("") && sudahAda.add(tp)){
                        CmbTypeBarang.addItem(tp);
                    }
                }
            }
        }catch(Exception e){
            System.out.println("Notif type_barang : "+e);
        }finally{
            try{
                if(rs!=null){
                    rs.close();
                ...
                System.out.println("Notif type_barang close : "+e);
            }
        }
        if(CmbTypeBarang.getItemCount()>0){
            CmbTypeBarang.setSelectedIndex(0);
