...
public class DlgRekapPerShift extends javax.swing.JDialog {
    ...
    private final DateTimeFormatter fmtTanggal=DateTimeFormatter.ofPattern("yyyy-MM-dd");
    ...
    private String sqlpsjamshift="select * from closing_kasir where shift like ? ",
    ...
    private LocalDate getPeriodeMulai() {
        try {
            return LocalDate.parse(Valid.SetTgl(Tgl1.getSelectedItem()+""),fmtTanggal);
        } catch (DateTimeParseException e) {
            return LocalDate.now();
        }
    }

    private LocalDate getPeriodeSampai() {
        try {
            return LocalDate.parse(Valid.SetTgl(Tgl2.getSelectedItem()+""),fmtTanggal);
        } catch (DateTimeParseException e) {
            return LocalDate.now();
        }
    }

    private String[] getRentangWaktuShift(LocalDate tanggal, String jamMasuk, String jamPulang, String shift) {
        LocalDate tanggalAkhir=tanggal;
        try {
            LocalTime mulai=LocalTime.parse(jamMasuk);
            LocalTime pulang=LocalTime.parse(jamPulang);
            if(shift.equals("Malam")||!pulang.isAfter(mulai)){
        ...
        return new String[]{
            tanggal.format(fmtTanggal)+" "+jamMasuk,
            tanggalAkhir.format(fmtTanggal)+" "+jamPulang
        };
    }
    ...
    private void initComponents() {
        ...
        Tgl1.setToolTipText("Tanggal mulai");
        ...
        label13.setPreferredSize(new java.awt.Dimension(23, 23));
        panelGlass5.add(label13);

        Tgl2.setDisplayFormat("dd-MM-yyyy");
        Tgl2.setName("Tgl2"); // NOI18N
        Tgl2.setToolTipText("Tanggal akhir");
    ...
    */
    ...
    private void tampilralan() {
        ...
        LocalDate periodeMulai=getPeriodeMulai();
        LocalDate periodeSampai=getPeriodeSampai();
        if(periodeSampai.isBefore(periodeMulai)){
            LocalDate tmp=periodeMulai;
            periodeMulai=periodeSampai;
            periodeSampai=tmp;
        }
        try{
            ...
            try{
                ...
                while(rs.next()){
                    tabModeRalan.addRow(new Object[]{
                        "Shift : "+rs.getString("shift")+" ("+periodeMulai.format(fmtTanggal)+" s.d "+periodeSampai.format(fmtTanggal)+")",
                    ...
                    try {
                        ...
                        i=1;
                        LocalDate tanggalProses=periodeMulai;
                        while(!tanggalProses.isAfter(periodeSampai)){
                            String[] rentangWaktu=getRentangWaktuShift(
                                    tanggalProses,rs.getString("jam_masuk"),rs.getString("jam_pulang"),rs.getString("shift")
                            );
                            pspasienralan.setString(1,rentangWaktu[0]);
                            pspasienralan.setString(2,rentangWaktu[1]);
                            ...
                            tanggalProses=tanggalProses.plusDays(1);
                        }
                        tabModeRalan.addRow(new Object[] {
                            "   >> Total",":","","","",
                ...
                while(rs.next()){
                    ...
                    try{
                        ...
                        while(!tanggalProses.isAfter(periodeSampai)){
                            ...
                            pspasienranap.setString(1,rentangWaktu[0]);
                            pspasienranap.setString(2,rentangWaktu[1]);
                ...
                while(rs.next()){
                    ...
                    try{
                        ...
                        while(!tanggalProses.isAfter(periodeSampai)){
                            ...
                            pspemasukan.setString(1,rentangWaktu[0]);
                            pspemasukan.setString(2,rentangWaktu[1]);
                ...
                while(rs.next()){
                    ...
                    try{
                        ...
                        while(!tanggalProses.isAfter(periodeSampai)){
                            ...
                            pspengeluaran.setString(1,rentangWaktu[0]);
                            pspengeluaran.setString(2,rentangWaktu[1]);
