        ...
        if (jfc.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                while (sc.hasNextLine()){  
                    ...
                    if(parts.length >= 2){
                        strData.append("{\"nosep\":\"").append(parts[0].trim()).append("\",\"dibayar\":").append(parts[1].trim()).append("},");
                    }
                }   
                
                String jsonStr = strData.toString();
                if(jsonStr.endsWith(",")){
                            ...
                            try {
                                ...
                                if(rs.next()){
                                    ...
                                    if(rs.getDouble("totalpiutang")==totalbiaya){
                                        ...
                                        // Cek Duplikat sebelum dimasukkan ke layar
                                        boolean isDuplicate = false;
                                        for(int i = 0; i < tabMode.getRowCount(); i++) {
                                            if(tabMode.getValueAt(i, 2).toString().equals(rs.getString("no_sep"))) {
                                                isDuplicate = true;
                                                break;
                                            }
                                        }
                            ...
                            try {
                                ...
                                if(rs.next()){
                                    ...
                                    if(rs.getDouble("totalpiutang")==totalbiaya){
                                        ...
                                        // Cek Duplikat sebelum dimasukkan ke layar
                                        boolean isDuplicate = false;
                                        for(int idx = 0; idx < tabMode.getRowCount(); idx++) {
                                            if(tabMode.getValueAt(idx, 2).toString().equals(rs.getString("no_sep"))) {
                                                isDuplicate = true;
                                                break;
                                            }
                                        }
