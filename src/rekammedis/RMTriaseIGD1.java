 ...
 * @author perpustakaan
 */
public final class RMTriaseIGD1 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMTriaseIGD1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        tgl_kunjungan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-05-2025 16:20:18" }));
        ...
        tgl_kejadian_tunggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-05-2025 16:20:19" }));
        ...
        tgl_kejadian.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-05-2025 16:20:19" }));
        ...
        jLabel34.setText("( UNTUK LEVEL PACS, DI ISI OLEH DOKTER )");
        jLabel34.setName("jLabel34"); // NOI18N
        FormInput.add(jLabel34);
        jLabel34.setBounds(360, 580, 380, 23);
        ...
        jLabel63.setText("LEVEL TRIASE (PATIENT'S ACUITY CATEGORIZATION SCALE / PACS) :");
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tbTriase.getSelectedRow() > -1) {
            ...
            Valid.MyReportqry("rptTriaseIGD.jasper", "report", "::[ Laporan Data Triase IGD ]::",
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMTriaseIGD1 dialog = new RMTriaseIGD1(new javax.swing.JFrame(), true);
