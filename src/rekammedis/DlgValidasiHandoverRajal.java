...
public class DlgValidasiHandoverRajal extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgValidasiHandoverRajal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         setSize(1285,674);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgValidasiHandoverRajal dialog = new DlgValidasiHandoverRajal(new javax.swing.JFrame(), true);
...
//                                "order by pemeriksaan_ralan.tgl_perawatan,pemeriksaan_ralan.jam_rawat").executeQuery();
                        rs2=koneksi.prepareStatement(
                                "select pemeriksaan_ralan.tgl_perawatan,pemeriksaan_ralan.jam_rawat,pemeriksaan_ralan.keluhan,"+
                                "pemeriksaan_ralan.pemeriksaan,pemeriksaan_ralan.rtl,pemeriksaan_ralan.penilaian,pemeriksaan_ralan.nip,pegawai.nama,departemen.nama, "+
                                "validasi_handover_rajal.nik_validator,namavalidator.nama as namavalidator,validasi_handover_rajal.tgl_validasi,validasi_handover_rajal.jam_validasi,validasi_handover_rajal.status_validasi "+ 
                                "from pemeriksaan_ralan LEFT JOIN validasi_handover_rajal ON validasi_handover_rajal.no_rawat = pemeriksaan_ralan.no_rawat AND validasi_handover_rajal.tgl_perawatan = pemeriksaan_ralan.tgl_perawatan AND validasi_handover_rajal.jam_rawat = pemeriksaan_ralan.jam_rawat inner join pegawai on pemeriksaan_ralan.nip=pegawai.nik inner join departemen on pegawai.departemen=departemen.dep_id LEFT JOIN pegawai AS namavalidator ON validasi_handover_rajal.nik_validator=namavalidator.nik where pemeriksaan_ralan.no_rawat='"+rs.getString("no_rawat")+"' "+
                                "order by pemeriksaan_ralan.tgl_perawatan,pemeriksaan_ralan.jam_rawat").executeQuery();
                        if(rs2.next()){
                            htmlContent.append(
                                    "<tr class='isi'>"+
                            ...
                            while(rs2.next()){
                                ...
                                if(Sequel.cariInteger("select count(validasi_handover_rajal.nik_validator) " +
                                        "from pemeriksaan_ralan LEFT JOIN validasi_handover_rajal ON validasi_handover_rajal.no_rawat = pemeriksaan_ralan.no_rawat AND validasi_handover_rajal.tgl_perawatan = pemeriksaan_ralan.tgl_perawatan AND validasi_handover_rajal.jam_rawat = pemeriksaan_ralan.jam_rawat inner join pegawai on pemeriksaan_ralan.nip=pegawai.nik inner join departemen on pegawai.departemen=departemen.dep_id LEFT JOIN pegawai AS namavalidator ON validasi_handover_rajal.nik_validator=namavalidator.nik where pemeriksaan_ralan.no_rawat='"+rs.getString("no_rawat")+"' AND validasi_handover_rajal.nik_validator='"+rs2.getString("nik_validator")+"'" +
