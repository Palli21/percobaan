...
//        }else if(NmDokter.getText().trim().equals("")){ bisa menyimpan nama dokter lain
//            Valid.textKosong(BtnDokter,"Dokter");
        }else if(KeluhanUtama.getText().trim().equals("")){
            Valid.textKosong(KeluhanUtama,"Keluhan Utama");
        }else{
            if(Sequel.menyimpantf("penilaian_medis_ranap","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",41,new String[]{
                    TNoRw.getText(),NmDokter.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),
                    ...
                    Kulit.getSelectedItem().toString(),KetFisik.getText(),KetLokalis.getText(),Laborat.getText(),Radiologi.getText(),Penunjang.getText(),Diagnosis.getText(),Tatalaksana.getText(),Edukasi.getText(),RPS.getText(),RPK.getText(),RPD.getText(),RPO.getText()
                })==true){
                    emptTeks();
            }
        }
    ...
    */
    ...
    private void ambildataawalmedisigd(){
        try{
            ...
            "penilaian_medis_igd.ket_fisik,penilaian_medis_igd.ket_lokalis,penilaian_medis_igd.ekg,penilaian_medis_igd.hasil,penilaian_medis_igd.nilai,penilaian_medis_igd.diagnosis,penilaian_medis_igd.tata "+
            ...
            try{
                ...
                while(rs.next()){
                    ...
                    KetLokalis.setText(rs.getString("ket_lokalis"));
                    Laborat.setText(rs.getString("nilai"));
