 ...
 * @author windiarto
 */
public final class RMRiwayatKonsul extends javax.swing.JDialog {    
...
//    private final DefaultTableModel tabModeRegistrasi;
     ...
     * @param parent
     * @param modal */
    public RMRiwayatKonsul(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        chkKonsultasiMedik.setText("Surat Konsul");
        ...
        TabRawat.addTab("Riwayat Konsul", internalFrame2);
               ...
               if(chkKonsultasiMedik.isSelected()==true){
                try {
                    rs2=koneksi.prepareStatement(
                        ...
                        "where konsultasi_medik.no_rawat='"+rs.getString("no_rawat")+"' order by konsultasi_medik.tanggal,konsultasi_medik.no_permintaan").executeQuery();
                    if(rs2.next()){
                        htmlContent.append(
                          "<tr class='isi'>"+ 
                            "<td valign='top' width='2%'></td>"+        
