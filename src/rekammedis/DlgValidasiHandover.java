...
public class DlgValidasiHandover extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgValidasiHandover(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         setSize(1285,674);
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Status Serah Terimah ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Liberation Sans", 0, 13), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgValidasiHandover dialog = new DlgValidasiHandover(new javax.swing.JFrame(), true);
...
//                                "order by pemeriksaan_ranap.tgl_perawatan,pemeriksaan_ranap.jam_rawat").executeQuery();
                        rs2=koneksi.prepareStatement(
                                ...
                                "from pemeriksaan_ranap LEFT JOIN validasi_handover ON validasi_handover.no_rawat = pemeriksaan_ranap.no_rawat AND validasi_handover.tgl_perawatan = pemeriksaan_ranap.tgl_perawatan AND validasi_handover.jam_rawat = pemeriksaan_ranap.jam_rawat inner join pegawai on pemeriksaan_ranap.nip=pegawai.nik inner join departemen on pegawai.departemen=departemen.dep_id LEFT JOIN pegawai AS namavalidator ON validasi_handover.nik_validator=namavalidator.nik where pemeriksaan_ranap.no_rawat='"+rs.getString("no_rawat")+"' "+
                                "order by pemeriksaan_ranap.tgl_perawatan,pemeriksaan_ranap.jam_rawat").executeQuery();
                        if(rs2.next()){
                            htmlContent.append(
                                    "<tr class='isi'>"+
                            ...
                            while(rs2.next()){
                                ...
                                if(Sequel.cariInteger("select count(validasi_handover.nik_validator) " +
                                        "from pemeriksaan_ranap LEFT JOIN validasi_handover ON validasi_handover.no_rawat = pemeriksaan_ranap.no_rawat AND validasi_handover.tgl_perawatan = pemeriksaan_ranap.tgl_perawatan AND validasi_handover.jam_rawat = pemeriksaan_ranap.jam_rawat inner join pegawai on pemeriksaan_ranap.nip=pegawai.nik inner join departemen on pegawai.departemen=departemen.dep_id LEFT JOIN pegawai AS namavalidator ON validasi_handover.nik_validator=namavalidator.nik where pemeriksaan_ranap.no_rawat='"+rs.getString("no_rawat")+"' AND validasi_handover.nik_validator='"+rs2.getString("nik_validator")+"'" +
                                        "order by pemeriksaan_ranap.tgl_perawatan,pemeriksaan_ranap.jam_rawat")>0){
                                    gbrverif="<img src ='http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/images/Sudahditerima.png' align='center' width='100' height='50'/";
                                }else{
                                    gbrverif="<img src ='http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/images/Belumditerima.png' align='center' width='100' height='50'/";
                                }
//                                 System.out.println("Notif Rekening : "+stylee);
//                                 System.out.println("Notif Rekening : "+rs2.getString("nik"));
                                //2021/04/18/000056
