                    ...
                    try {
                        ...
                        if ("waha".equalsIgnoreCase(waGateway)) {
                            ...
                            if (!result.ok) {
                                ...
                                Sequel.queryu("INSERT INTO wa_report VALUES ('" + result.messageId + "', '" + TNoRM.getText() + "', '" + noWa + "', '" + akses.getkode() + "', 'Kirim Hasil USG', '" + result.chatId + "', '" + simpanPesan + "', '', 'true', '', '" + dateNow + "', '" + dateNow + "')");
                            ...
                            WagolangClient.Result result;
                            String pesanKirim = urlHasil.trim().isEmpty() ? pesan : pesan + "\n\n" + urlHasil;
                            if (!urlHasil.trim().isEmpty()) {
                                result = WagolangClient.sendFile(noWa, urlHasil, pesan);
                                if (!result.ok) {
                                    result = WagolangClient.sendFileFromUrl(noWa, urlHasil, pesan);
                                }
                                if (!result.ok) {
                                    result = WagolangClient.sendText(noWa, pesanKirim);
                                }
                            } else {
