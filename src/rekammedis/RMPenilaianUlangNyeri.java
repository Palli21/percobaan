...
public final class RMPenilaianUlangNyeri extends javax.swing.JDialog {
    ...
    public RMPenilaianUlangNyeri(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Ket. Kualitas","Lokasi","Menyebar","Skala Nyeri","Durasi","Nyeri Hilang","Ket. Hilang Nyeri","NIP","PJ.Unit","Intervensi Farmakologis","Intervensi Non Farmakologis","Perawat/Bidan"
        }){
        ...
        Intervensi.setDocument(new batasInput((int)80).getKata(Intervensi));
        IntervensiNon.setDocument(new batasInput((int)80).getKata(IntervensiNon));
        Perawat.setDocument(new batasInput((int)80).getKata(Perawat));
    ...
    private void initComponents() {
        ...
        IntervensiNon = new widget.TextBox();
        ...
        jLabel91.setText("Intervensi Farmakolgis:");
        jLabel91.setName("jLabel91"); // NOI18N
        FormInput.add(jLabel91);
        jLabel91.setBounds(320, 250, 140, 23);
        ...
        Intervensi.setBounds(460, 250, 370, 23);

        jLabel92.setText("Intervensi Non Farmakologis :");
        jLabel92.setName("jLabel92"); // NOI18N
        FormInput.add(jLabel92);
        jLabel92.setBounds(310, 280, 150, 23);

        IntervensiNon.setFocusTraversalPolicyProvider(true);
        IntervensiNon.setName("IntervensiNon"); // NOI18N
        IntervensiNon.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                IntervensiNonKeyPressed(evt);
            }
        });
        FormInput.add(IntervensiNon);
        IntervensiNon.setBounds(460, 280, 370, 23);

        jLabel93.setText("Nama Perawat/Bidan :");
        jLabel93.setName("jLabel93"); // NOI18N
        FormInput.add(jLabel93);
        jLabel93.setBounds(310, 310, 150, 23);

        Perawat.setFocusTraversalPolicyProvider(true);
        Perawat.setName("Perawat"); // NOI18N
        Perawat.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PerawatKeyPressed(evt);
            }
        });
        FormInput.add(Perawat);
        Perawat.setBounds(460, 310, 370, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_ulang_nyeri","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",17,new String[]{
                ...
                KetNyeri.getText(),NIP.getText(),Intervensi.getText(),IntervensiNon.getText(),Perawat.getText()
            })==true){
                tabMode.addRow(new String[]{
                    ...
                    SkalaNyeri.getSelectedItem().toString(),Durasi.getText(),NyeriHilang.getSelectedItem().toString(),KetNyeri.getText(),NIP.getText(),NamaPetugas.getText(),Intervensi.getText(),IntervensiNon.getText(),Perawat.getText()
                });
                emptTeks();
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptPenilaianUlangNyeri.jasper","report","::[ Data Penilaian Ulang Nyeri ]::",
                    ...
                    "penilaian_ulang_nyeri.durasi,penilaian_ulang_nyeri.nyeri_hilang,penilaian_ulang_nyeri.ket_nyeri,penilaian_ulang_nyeri.nip,petugas.nama,penilaian_ulang_nyeri.intervensi,penilaian_ulang_nyeri.intervensinon,penilaian_ulang_nyeri.perawat "+
    ...
    private void IntervensiNonKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_IntervensiNonKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_IntervensiNonKeyPressed

    private void PerawatKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PerawatKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_PerawatKeyPressed
    ...
    */
    ...
    private widget.TextBox IntervensiNon;
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("nama"),rs.getString("intervensi"),rs.getString("intervensinon"),rs.getString("perawat")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Intervensi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),17).toString());
            IntervensiNon.setText(tbObat.getValueAt(tbObat.getSelectedRow(),18).toString());
