...
public final class RMDataResumePasienRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(1108, 1700));
        ...
        jLabel25.setBounds(40, 1090, 145, 23);
        ...
        DiagnosaSekunder2.setBounds(190, 1090, 520, 23);

        jLabel26.setText("Diagnosa Sekunder 3 :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(40, 1120, 145, 23);
        ...
        DiagnosaUtama.setBounds(190, 1030, 520, 23);

        jLabel27.setText("Diagnosa Utama :");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(40, 1030, 145, 23);
        ...
        DiagnosaSekunder3.setBounds(190, 1120, 520, 23);

        jLabel28.setText("Diagnosa Sekunder 4 :");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(40, 1150, 145, 23);
        ...
        DiagnosaSekunder4.setBounds(190, 1150, 520, 23);
        ...
        jLabel29.setText("Diagnosa Akhir, bisa di input manual !!!");
        jLabel29.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(300, 1000, 240, 23);

        jLabel30.setText("Diagnosa Sekunder 1 :");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(40, 1060, 145, 23);
        ...
        DiagnosaSekunder1.setBounds(190, 1060, 520, 23);

        jLabel31.setText("Kode ICD :");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(740, 1010, 70, 23);
        ...
        KodeDiagnosaUtama.setBounds(750, 1030, 75, 23);
        ...
        KodeDiagnosaSekunder1.setBounds(750, 1060, 75, 23);
        ...
        KodeDiagnosaSekunder2.setBounds(750, 1090, 75, 23);
        ...
        KodeDiagnosaSekunder3.setBounds(750, 1120, 75, 23);
        ...
        KodeDiagnosaSekunder4.setBounds(750, 1150, 75, 23);

        jLabel32.setText("Prosedur Utama :");
        jLabel32.setName("jLabel32"); // NOI18N
        FormInput.add(jLabel32);
        jLabel32.setBounds(40, 1180, 145, 23);
        ...
        ProsedurUtama.setBounds(190, 1180, 520, 23);
        ...
        KodeProsedurUtama.setBounds(750, 1180, 75, 23);
        ...
        ProsedurSekunder1.setBounds(190, 1210, 520, 23);

        jLabel33.setText("Prosedur Sekunder 1 :");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput.add(jLabel33);
        jLabel33.setBounds(40, 1210, 145, 23);
        ...
        KodeProsedurSekunder1.setBounds(750, 1210, 75, 23);

        jLabel34.setText("Prosedur Sekunder 2 :");
        jLabel34.setName("jLabel34"); // NOI18N
        FormInput.add(jLabel34);
        jLabel34.setBounds(40, 1240, 145, 23);
        ...
        ProsedurSekunder2.setBounds(190, 1240, 520, 23);
        ...
        KodeProsedurSekunder2.setBounds(750, 1240, 75, 23);
        ...
        KodeProsedurSekunder3.setBounds(750, 1270, 75, 23);
        ...
        ProsedurSekunder3.setBounds(190, 1270, 520, 23);

        jLabel35.setText("Prosedur Sekunder 3 :");
        jLabel35.setName("jLabel35"); // NOI18N
        FormInput.add(jLabel35);
        jLabel35.setBounds(40, 1270, 145, 23);
        ...
        BtnDokter1.setBounds(80, 186, 140, 23);

        BtnDokter2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnDokter2.setMnemonic('2');
        BtnDokter2.setText("Riwayat Penunjang");
        ...
        BtnDokter3.setBounds(108, 630, 110, 23);

        jLabel37.setText("Cara Keluar :");
        jLabel37.setName("jLabel37"); // NOI18N
        FormInput.add(jLabel37);
        jLabel37.setBounds(440, 1550, 70, 23);
        ...
        CaraKeluar.setBounds(520, 1550, 205, 23);

        jLabel36.setText("Keadaan Pulang :");
        jLabel36.setName("jLabel36"); // NOI18N
        FormInput.add(jLabel36);
        jLabel36.setBounds(60, 1550, 100, 23);
        ...
        BtnDokter5.setBounds(30, 300, 200, 23);
        ...
        jLabel23.setBounds(540, 2000, 120, 23);
        ...
        Alasan.setBounds(670, 2000, 310, 23);
        ...
        BtnDokter16.setText("Riwayat Operasi");
        ...
        BtnDokter16.setBounds(78, 730, 140, 23);
        ...
        jLabel38.setBounds(60, 1400, 100, 23);
        ...
        Alergi.setBounds(170, 1400, 681, 23);

        jLabel39.setText("Diet :");
        jLabel39.setName("jLabel39"); // NOI18N
        FormInput.add(jLabel39);
        jLabel39.setBounds(60, 1430, 100, 23);
        ...
        KetKeluar.setBounds(730, 1550, 125, 23);

        jLabel40.setText("Hasil Lab Yang Belum Selesai (Pending) :");
        jLabel40.setName("jLabel40"); // NOI18N
        FormInput.add(jLabel40);
        jLabel40.setBounds(40, 2050, 230, 23);
        ...
        BtnDokter17.setBounds(210, 2070, 28, 23);
        ...
        scrollPane8.setBounds(170, 1430, 681, 50);

        jLabel41.setText("Instruksi/Anjuran Dan Edukasi (Follow Up) :");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(60, 1490, 230, 23);
        ...
        scrollPane9.setBounds(300, 1490, 551, 50);
        ...
        KetKeadaanPulang.setBounds(310, 1550, 130, 23);

        jLabel42.setText("Dilanjutkan :");
        jLabel42.setName("jLabel42"); // NOI18N
        FormInput.add(jLabel42);
        jLabel42.setBounds(60, 1580, 100, 23);
        ...
        DIlanjutkan.setBounds(170, 1580, 130, 23);
        ...
        KetDilanjutkan.setBounds(310, 1580, 270, 23);

        Kontrol.setForeground(new java.awt.Color(50, 70, 50));
        Kontrol.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-01-2026 12:30:18" }));
        ...
        BtnDokter18.setBounds(140, 1450, 28, 23);
        ...
        scrollPane10.setBounds(280, 2050, 551, 50);
        ...
        scrollPane11.setBounds(180, 1620, 681, 50);
        ...
        BtnDokter20.setBounds(98, 810, 120, 23);
        ...
        BtnAsesmen.setText("Riwayat Konsul");
        ...
        BtnAsesmen.setBounds(88, 910, 130, 23);
        ...
        BtnSimpan1.setBounds(830, 1020, 100, 30);
        ...
        BtnAmbilDataIGDSpesialis.setBounds(810, 170, 230, 30);

        jLabel43.setText("Diagnosa Akhir :");
        jLabel43.setName("jLabel43"); // NOI18N
        FormInput.add(jLabel43);
        jLabel43.setBounds(40, 1010, 100, 23);
        ...
        ProsedurSekunder4.setBounds(190, 1300, 520, 23);

        jLabel44.setText("Prosedur Sekunder 4 :");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(40, 1300, 145, 23);
        ...
        KodeProsedurSekunder4.setBounds(750, 1300, 75, 23);

        jLabel45.setText("Prosedur Sekunder 5 :");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput.add(jLabel45);
        jLabel45.setBounds(40, 1330, 145, 23);
        ...
        ProsedurSekunder5.setBounds(190, 1330, 520, 23);
        ...
        KodeProsedurSekunder5.setBounds(750, 1330, 75, 23);
        ...
        KodeProsedurSekunder6.setBounds(750, 1360, 75, 23);
        ...
        ProsedurSekunder6.setBounds(190, 1360, 520, 23);

        jLabel46.setText("Prosedur Sekunder 6 :");
        jLabel46.setName("jLabel46"); // NOI18N
        FormInput.add(jLabel46);
        jLabel46.setBounds(40, 1360, 145, 23);
...
//            Valid.textKosong(DiagnosaUtama,"Diagnosa Utama");
            ...
            if(Sequel.menyimpantf("resume_pasien_ranap","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",41,new String[]{
                    ...
                    Valid.SetTglJam(Kontrol.getSelectedItem()+""),ObatPulang.getText()
                })==true){
                    tabMode.addRow(new String[]{
                        ...
                        Valid.SetTglJam(Kontrol.getSelectedItem()+""),ObatPulang.getText(),KdPj.getText(),CaraBayar.getText()
                    });
                    emptTeks();
    ...
    private void ganti() {
        if(Sequel.mengedittf("resume_pasien_ranap","no_rawat=?","no_rawat=?,kd_dokter=?,diagnosa_awal=?,alasan=?,keluhan_utama=?,pemeriksaan_fisik=?,jalannya_penyakit=?,pemeriksaan_penunjang=?,"+
                ...
                tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
                   ...
                   tbObat.setValueAt(Valid.SetTglJam(Kontrol.getSelectedItem()+""),tbObat.getSelectedRow(),50);
