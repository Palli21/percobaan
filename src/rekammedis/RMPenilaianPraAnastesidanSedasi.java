...
public final class RMPenilaianPraAnastesidanSedasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        PenyakitKebiasaanObat1 = new widget.ComboBox();
        RencanaPerawatan1 = new widget.TextBox();
        jLabel131 = new widget.Label();
        PenyakitKebiasaanObat2 = new widget.ComboBox();
        RencanaPerawatan2 = new widget.TextBox();
        jLabel132 = new widget.Label();
        PenyakitKebiasaanObat3 = new widget.ComboBox();
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-06-2024 16:47:06" }));
        ...
        TglOperasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-06-2024 16:47:06" }));
        ...
        Pernapasan.setBounds(130, 390, 600, 23);
        ...
        FisikCardio.setBounds(120, 330, 610, 23);
        ...
        FisikParu.setBounds(160, 450, 70, 23);
        ...
        FisikAbdomen.setBounds(300, 450, 60, 23);
        ...
        FisikExtrimitas.setBounds(440, 450, 70, 23);
        ...
        FisikEndokrin.setBounds(590, 450, 70, 23);
        ...
        FisikGinjal.setBounds(130, 510, 590, 23);
        ...
        FisikObat.setBounds(130, 540, 590, 23);
        ...
        FisikLaborat.setBounds(420, 720, 160, 23);
        ...
        FisikPenunjang.setBounds(690, 720, 40, 23);
        ...
        jLabel110.setBounds(20, 390, 100, 23);
        ...
        PenyakitAlergiObat.setBounds(200, 480, 180, 23);
        ...
        PenyakitAlergiLainnya.setBounds(470, 480, 150, 23);
        ...
        PenyakitTerapi.setBounds(750, 480, 190, 23);
        ...
        PenyakitKebiasaanMerokok.setBounds(180, 200, 90, 23);
        ...
        PenyakitKebiasaanJumlahRokok.setBounds(130, 570, 590, 23);
        ...
        PenyakitKebiasaanAlkohol.setBounds(180, 230, 90, 23);
        ...
        PenyakitKebiasaanJumlahAlkohol.setBounds(130, 600, 590, 23);
        ...
        PenyakitKebiasaanObat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Spinal", "Epidural", "Kaudal ", "Blok Perifer", " " }));
        ...
        PenyakitKebiasaanObat.setBounds(630, 840, 155, 23);
        ...
        PenyakitKebiasaanObatDiminum.setBounds(200, 720, 120, 23);
        ...
        MedisCardio.setBounds(130, 630, 590, 23);
        ...
        MedisRespiratory.setBounds(130, 660, 590, 23);
        ...
        MedisEndocrine.setBounds(300, 750, 430, 23);
        ...
        MedisLainnya.setBounds(70, 840, 240, 23);
        ...
        RencanaAnestesi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        ...
        RencanaAnestesi.setBounds(360, 230, 60, 23);

        AngkaASA.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        ...
        AngkaASA.setBounds(360, 200, 60, 23);
        ...
        RencanaPerawatan.setBounds(670, 870, 180, 23);
        ...
        CatatanKhusus.setBounds(110, 870, 300, 23);
        ...
        PenyakitKebiasaanObat1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Hipotensi", "Ventilasi satu paru", "TCI", "Lainnya", " " }));
        PenyakitKebiasaanObat1.setName("PenyakitKebiasaanObat1"); // NOI18N
        PenyakitKebiasaanObat1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PenyakitKebiasaanObat1KeyPressed(evt);
            }
        });
        FormInput.add(PenyakitKebiasaanObat1);
        PenyakitKebiasaanObat1.setBounds(515, 870, 140, 23);

        RencanaPerawatan1.setFocusTraversalPolicyProvider(true);
        RencanaPerawatan1.setName("RencanaPerawatan1"); // NOI18N
        RencanaPerawatan1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                RencanaPerawatan1KeyPressed(evt);
            }
        });
        FormInput.add(RencanaPerawatan1);
        RencanaPerawatan1.setBounds(370, 840, 180, 23);
        ...
        PenyakitKebiasaanObat2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "EKG lead", "CVP", "SpO2", "Arteri line", "NIBP", "Temp", "EtCO2", "BIS", "Lainnya", " " }));
        PenyakitKebiasaanObat2.setName("PenyakitKebiasaanObat2"); // NOI18N
        PenyakitKebiasaanObat2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PenyakitKebiasaanObat2KeyPressed(evt);
            }
        });
        FormInput.add(PenyakitKebiasaanObat2);
        PenyakitKebiasaanObat2.setBounds(100, 900, 140, 23);

        RencanaPerawatan2.setFocusTraversalPolicyProvider(true);
        RencanaPerawatan2.setName("RencanaPerawatan2"); // NOI18N
        RencanaPerawatan2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                RencanaPerawatan2KeyPressed(evt);
            }
        });
        FormInput.add(RencanaPerawatan2);
        RencanaPerawatan2.setBounds(260, 900, 180, 23);
        ...
        PenyakitKebiasaanObat3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Rawat jalan", "Rawat inap", "ICU", "NICU", " " }));
        PenyakitKebiasaanObat3.setName("PenyakitKebiasaanObat3"); // NOI18N
        PenyakitKebiasaanObat3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PenyakitKebiasaanObat3KeyPressed(evt);
            }
        });
        FormInput.add(PenyakitKebiasaanObat3);
        PenyakitKebiasaanObat3.setBounds(610, 900, 150, 23);
        ...
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_pre_anestesi","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat, Tanggal & Jam",40,new String[]{
                    ...
                    tabMode.addRow(new String[]{
                        ...
                        MedisRespiratory.getText(),MedisEndocrine.getText(),MedisLainnya.getText(),AngkaASA.getSelectedItem().toString(),
                        RencanaAnestesi.getSelectedItem().toString(),RencanaPerawatan.getText(),CatatanKhusus.getText()
                    });
                    emptTeks();
    ...
    private void PenyakitKebiasaanObat1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PenyakitKebiasaanObat1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_PenyakitKebiasaanObat1KeyPressed

    private void RencanaPerawatan1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_RencanaPerawatan1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_RencanaPerawatan1KeyPressed

    private void PenyakitKebiasaanObat2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PenyakitKebiasaanObat2KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_PenyakitKebiasaanObat2KeyPressed

    private void RencanaPerawatan2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_RencanaPerawatan2KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_RencanaPerawatan2KeyPressed

    private void PenyakitKebiasaanObat3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PenyakitKebiasaanObat3KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_PenyakitKebiasaanObat3KeyPressed
    ...
    */
    ...
    private widget.ComboBox PenyakitKebiasaanObat1;
    private widget.ComboBox PenyakitKebiasaanObat2;
    private widget.ComboBox PenyakitKebiasaanObat3;
    ...
    private widget.TextBox RencanaPerawatan1;
    private widget.TextBox RencanaPerawatan2;
