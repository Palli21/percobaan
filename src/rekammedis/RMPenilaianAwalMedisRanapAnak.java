...
public final class RMPenilaianAwalMedisRanapAnak extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KetFisik.setBounds(1120, 320, 220, 23);
        ...
        Alergi.setBounds(200, 260, 220, 23);
        ...
        Keadaan.setBounds(50, 970, 130, 23);
        ...
        Kesadaran.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normal", "Abnormal", "Tidak Diperiksa" }));
        ...
        Kesadaran.setBounds(500, 380, 130, 23);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-06-2024 06:57:56" }));
        ...
        jLabel43.setBounds(520, 190, 70, 23);

        Kesadaran1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak" }));
        ...
        Kesadaran1.setBounds(600, 190, 130, 23);
        ...
        KetFisik1.setBounds(1120, 290, 220, 23);
        ...
        scrollPane15.setViewportView(Diagnosis1);
        ...
        Keadaan1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normal", "Abnormal", "Tidak Diperiksa" }));
        ...
        Keadaan1.setBounds(60, 380, 130, 23);

        Keadaan2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak" }));
        ...
        Keadaan2.setBounds(70, 1080, 130, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_medis_ranap_anak","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",40,new String[]{
                    ...
                    Nadi.getText(),KetFisik.getText(),Suhu.getText(),SPO.getText(),BB.getText(),TB.getText(),Kepala.getSelectedItem().toString(),Mata.getSelectedItem().toString(),Gigi.getSelectedItem().toString(),THT.getSelectedItem().toString(),
                    ...
                    Kulit.getSelectedItem().toString(),KetFisik.getText(),Laborat.getText(),Radiologi.getText(),Penunjang.getText(),Diagnosis.getText(),Tatalaksana.getText(),Edukasi.getText()
                })==true){
                    emptTeks();
            }
        }
