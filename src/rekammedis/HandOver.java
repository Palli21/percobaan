 ...
 * @author perpustakaan
 */
public final class HandOver extends javax.swing.JDialog {
...
//    private int x = 0, i = 0, pilihan = 0;
     ...
     * @param parent
     * @param modal */
    public HandOver(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        label15.setBounds(550, 40, 90, 23);
        ...
        KodeNik1.setBounds(650, 40, 141, 23);
        ...
        NamaPegawai1.setBounds(800, 40, 270, 23);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            HandOver dialog = new HandOver(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "on pemeriksaan_ranap.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join pegawai on pemeriksaan_ranap.nip=pegawai.nik LEFT JOIN validasi_handover ON validasi_handover.no_rawat = pemeriksaan_ranap.no_rawat AND validasi_handover.tgl_perawatan = pemeriksaan_ranap.tgl_perawatan AND validasi_handover.jam_rawat = pemeriksaan_ranap.jam_rawat where "+
                    "pemeriksaan_ranap.no_rawat like ? and ISNULL(validasi_handover.status_validasi) order by pemeriksaan_ranap.no_rawat desc");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.tgl_registrasi,reg_periksa.status_lanjut,pemeriksaan_ranap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                    "pemeriksaan_ranap.tgl_perawatan,pemeriksaan_ranap.jam_rawat,pemeriksaan_ranap.keluhan, " +
