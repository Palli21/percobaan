...
public final class DlgKunjunganRanap extends javax.swing.JDialog {
    ...
    public DlgKunjunganRanap(java.awt.Frame parent, boolean modal) {
        ...
        setSize(885,674);
        tabMode=new DefaultTableModel(null,new String[]{"No.","Lama","Baru","Nama Pasien","L","P","Alamat","Kode","Diagnosa","Jaminan","Kelas","Ruang","Stts.Pulang","Tgl.Masuk","DPJP"}){
        ...
        tabMode2=new DefaultTableModel(null,new String[]{"No.","Lama","Baru","Nama Pasien","L","P","Alamat","Kode","Diagnosa","Jaminan","Kelas","Ruang","Stts.Pulang","Tgl.Pulang","DPJP"}){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
    ...
    */
    ...
    public void tampil(){        
        try{   
            ...
            ps=koneksi.prepareStatement(
                    ...
                    "kamar_inap.kd_kamar,bangsal.nm_bangsal,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab)as almt_pj,kamar_inap.stts_pulang,kamar_inap.tgl_masuk,dokter.nm_dokter,penjab.png_jawab,kamar.kelas "+
                ...
                while(rs.next()){
                    ...
                    if(dokterdpjp.toLowerCase().contains(nmdokter.getText().toLowerCase())){
                        ...
                        tabMode.addRow(new Object[]{
                            i,setlama,setbaru,rs.getString("nm_pasien"),umurlk,umurpr,rs.getString("almt_pj"),kddiagnosa,diagnosa,rs.getString("png_jawab"),rs.getString("kelas"),rs.getString("kd_kamar")+" "+rs.getString("nm_bangsal"),rs.getString("stts_pulang"),rs.getString("tgl_masuk"),dokterdpjp
                        });                
                        i++;
                    }
    ...
    public void tampil2(){        
        try{   
            ...
            ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.alamat,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur) as umur,pasien.tgl_daftar,reg_periksa.stts_daftar,"+
                    "kamar_inap.kd_kamar,bangsal.nm_bangsal,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab)as almt_pj,kamar_inap.stts_pulang,kamar_inap.tgl_keluar,dokter.nm_dokter,penjab.png_jawab,kamar.kelas "+
                    "from reg_periksa inner join pasien inner join kamar_inap inner join kamar inner join bangsal inner join dokter inner join penjab " +
                ...
                while(rs.next()){
                    ...
                    if(dokterdpjp.toLowerCase().contains(nmdokter.getText().toLowerCase())){
                        ...
                        tabMode2.addRow(new Object[]{
                            i,setlama,setbaru,rs.getString("nm_pasien"),umurlk,umurpr,rs.getString("almt_pj"),kddiagnosa,diagnosa,rs.getString("png_jawab"),rs.getString("kelas"),rs.getString("kd_kamar")+" "+rs.getString("nm_bangsal"),rs.getString("stts_pulang"),rs.getString("tgl_keluar"),dokterdpjp
                        });                
                        i++;
                    }
                }
