...
public final class DlgSensusHarianRalan extends javax.swing.JDialog {
    ...
    private String diagnosautama="",diagnosasekunder="",perujuk="",status="",pilihan="";
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        try {            
            ...
            File f;            
            BufferedWriter bw;  
            pilihan = (String)JOptionPane.showInputDialog(null,"Silahkan pilih laporan..!","Pilihan Cetak",JOptionPane.QUESTION_MESSAGE,null,new Object[]{"Laporan 1 (CSV)","Laporan 2 (Jasper)"},"Laporan 1 (CSV)");
            switch (pilihan){
                case "Laporan 1 (CSV)":
                htmlContent = new StringBuilder();
                htmlContent.append(                             
                            "\"No.\";\"Nomor RM\";\"Nama Pasien\";\"Tgl Lahir\";\"Tgl Daftar\";\"Poliklinik\";\"Dokter\";\"JK\";\"Rujukan Faskes lain\";\"Umur\";\"Cara Bayar\";\"Kecamatan\";\"Diagnosa Utama\";\"Diagnosa Tambahan\";\"ICD X Utama\";\"ICD X Tambahan\";\"Tindakan\";\"Hasil Akhir\";\"Pengunjung\";\"Jenis Kunjungan\";\"Jenis Kasus\"\n"
                        ); 
                        if(TabRawat.getSelectedIndex()==0){
                            for(i=0;i<tabmode.getRowCount();i++){  
                                htmlContent.append(                             
                                    ...
                                    + "\""+tabmode.getValueAt(i,10)+"\";\""+tabmode.getValueAt(i,11)+"\";\""+tabmode.getValueAt(i,12)+"\";\""+tabmode.getValueAt(i,13)+"\";\""+tabmode.getValueAt(i,14)+"\";\""+tabmode.getValueAt(i,15)+"\";\""+tabmode.getValueAt(i,16)+"\";\""+tabmode.getValueAt(i,17)+"\";\""+tabmode.getValueAt(i,18)+"\";\""+tabmode.getValueAt(i,19)+"\";\""+tabmode.getValueAt(i,20)+"\"\n"
                                ); 
                            } 
                        }else{
                        ...
                        f = new File("SensusHarianRalan.csv");            
