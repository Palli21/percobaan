...
public class DlgCariPermintaanRadiologi extends javax.swing.JDialog {
    ...
    public DlgCariPermintaanRadiologi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Permintaan","No.Rawat","Pasien","Permintaan","Jam","Sampel","Jam","Hasil","Jam","Kode Dokter","Dokter Perujuk","Poli Registrasi","Informasi Tambahan","Diagnosis Klinis","Kode Bayar","Jenis Bayar","Tanggal Lahir","Alamat"
            }){
        ...
        tabMode3=new DefaultTableModel(null,new Object[]{
            "No.Permintaan","No.Rawat","Pasien","Permintaan","Jam","Sampel","Jam","Hasil","Jam","Kode Dokter","Dokter Perujuk","Kamar Terakhir","Informasi Tambahan","Diagnosis Klinis","Kode Bayar","Jenis Bayar","Tanggal Lahir","Alamat"
            }){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
    ...
    private void initComponents() {
        ...
        BtnRiwayatKeperawatan = new widget.Button();
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-11-2025 13:21:59" }));
        ...
        BtnSampel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawahfolder.png"))); // NOI18N
        ...
        BtnHasil.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawahpenyerahn.png"))); // NOI18N
        ...
        BtnRiwayatPenunjang.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        ...
        BtnCetakHasilRadiologi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        ...
        BtnKirimDataFuji.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        ...
        BtnAmbilDataFUJI.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        ...
        BtnKirimDataCareStream.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        ...
        BtnAmbilDataFUJI1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        ...
        BtnKirimDataJii.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        ...
        BtnAmbilDataJii.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        ...
        BtnLihatGambarJii.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        ...
        BtnLihatGambarJiiAll.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        ...
        BtnKirimDataOrthanc1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        ...
        BtnKirimDataOrthanc.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        ...
        BtnRiwayatKeperawatan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        BtnRiwayatKeperawatan.setText("Riwayat Keperawatan");
        BtnRiwayatKeperawatan.setFocusPainted(false);
        BtnRiwayatKeperawatan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnRiwayatKeperawatan.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnRiwayatKeperawatan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnRiwayatKeperawatan.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnRiwayatKeperawatan.setName("BtnRiwayatKeperawatan"); // NOI18N
        BtnRiwayatKeperawatan.setPreferredSize(new java.awt.Dimension(215, 23));
        BtnRiwayatKeperawatan.setRoundRect(false);
        BtnRiwayatKeperawatan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnRiwayatKeperawatanActionPerformed(evt);
            }
        });
        FormMenu.add(BtnRiwayatKeperawatan);
...
private void tbRadiologiRalanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbRadiologiRalanKeyPressed
   if(tabMode.getRowCount()!=0){
    ...
    private void BtnRiwayatKeperawatanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRiwayatKeperawatanActionPerformed
        norm=Sequel.cariIsi("select reg_periksa.no_rkm_medis from reg_periksa where reg_periksa.no_rawat=? ",NoRawat);
        if(NoRawat.trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
            TCari.requestFocus();
    ...
    }//GEN-LAST:event_BtnRiwayatKeperawatanActionPerformed
    ...
    */
    ...
    private widget.Button BtnRiwayatKeperawatan;
    ...
    private void tampil() {
        ...
        try {
            ...
            ps=koneksi.prepareStatement(
                    "select permintaan_radiologi.noorder,permintaan_radiologi.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,permintaan_radiologi.tgl_permintaan,pasien.tgl_lahir,pasien.alamat,"+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("kd_pj"),rs.getString("png_jawab"),rs.getString("tgl_lahir"),rs.getString("alamat")
                    });
                    ps2=koneksi.prepareStatement(
                            "select permintaan_pemeriksaan_radiologi.kd_jenis_prw,jns_perawatan_radiologi.nm_perawatan "+
                            "from permintaan_pemeriksaan_radiologi inner join jns_perawatan_radiologi on "+
    ...
    private void tampil2() {
        ...
        try {
            semua=CrDokter.getText().trim().equals("")&&CrPoli.getText().trim().equals("")&&TCari.getText().trim().equals("");
            ps=koneksi.prepareStatement(
                    "select permintaan_radiologi.noorder,permintaan_radiologi.no_rawat,reg_periksa.no_rkm_medis,pasien.tgl_lahir,pasien.alamat,"+
...
//            tgl_lahir=tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),14).toString();
//            alamat=tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),15).toString();
