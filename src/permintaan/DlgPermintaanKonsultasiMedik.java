...
public class DlgPermintaanKonsultasiMedik extends javax.swing.JDialog {
    ...
    public DlgPermintaanKonsultasiMedik(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        UraianKonsultasi1.setEditable(false);
        DiagnosaKerja1.setEditable(false);
       ...
       // --- FULL SCREEN UNTUK FORM JAWABAN ---
// --- ukuran WindowInput : lebar ikut dialog utama, tinggi tetap sedang ---
java.awt.Dimension frameSize = this.getSize();

// Misal tinggi 650 (tidak berubah)
int tinggiJawaban = 671;

// Tambah lebar sedikit agar tidak sempit
int lebarJawaban = frameSize.width +1271;   // bisa ubah angka -40 sesuai selera

// Set ukuran WindowInput
WindowInput.setSize(lebarJawaban, tinggiJawaban);
WindowInput.setPreferredSize(new java.awt.Dimension(lebarJawaban, tinggiJawaban));
WindowInput.setMaximumSize(new java.awt.Dimension(lebarJawaban, tinggiJawaban));

// Tampilkan di tengah SIMRS
WindowInput.setLocationRelativeTo(this);
...
isMenu();
    ...
    private void initComponents() {
        ...
        DiagnosaKerja1 = new widget.TextBox();
        label3 = new widget.Label();
        scrollPane3 = new widget.ScrollPane();
        UraianKonsultasi1 = new widget.TextArea();
        jLabel43 = new widget.Label();
        JawabanDiagnosaKerja1 = new widget.TextBox();
        ...
        BtnKirimWhatsapp = new widget.Button();
        ...
        BtnCloseIn.setBounds(1070, 580, 100, 30);

        jLabel19.setText("-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
        jLabel19.setName("jLabel19"); // NOI18N
        internalFrame2.add(jLabel19);
        jLabel19.setBounds(40, 570, 1120, 13);
        ...
        BtnSimpanJawaban.setBounds(70, 580, 100, 30);
        ...
        BtnBatalJawaban.setBounds(190, 580, 100, 30);
        ...
        TanggalJawab.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-11-2025 21:50:49" }));
        ...
        jLabel42.setBounds(660, 50, 95, 23);
        ...
        scrollPane2.setBounds(30, 80, 621, 480);
        ...
        DiagnosaKerja1.setName("DiagnosaKerja1"); // NOI18N
        DiagnosaKerja1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                DiagnosaKerja1KeyPressed(evt);
            }
        });
        internalFrame2.add(DiagnosaKerja1);
        DiagnosaKerja1.setBounds(870, 20, 225, 23);

        label3.setText("Diagnosa Kerja :");
        label3.setName("label3"); // NOI18N
        internalFrame2.add(label3);
        label3.setBounds(780, 20, 90, 23);

        scrollPane3.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane3.setName("scrollPane3"); // NOI18N

        UraianKonsultasi1.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        UraianKonsultasi1.setColumns(20);
        UraianKonsultasi1.setRows(5);
        UraianKonsultasi1.setName("UraianKonsultasi1"); // NOI18N
        UraianKonsultasi1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                UraianKonsultasi1KeyPressed(evt);
            }
        });
        scrollPane3.setViewportView(UraianKonsultasi1);

        internalFrame2.add(scrollPane3);
        scrollPane3.setBounds(680, 80, 570, 480);

        jLabel43.setText("Jawaban :");
        jLabel43.setName("jLabel43"); // NOI18N
        internalFrame2.add(jLabel43);
        jLabel43.setBounds(0, 50, 95, 23);

        JawabanDiagnosaKerja1.setName("JawabanDiagnosaKerja1"); // NOI18N
        JawabanDiagnosaKerja1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                JawabanDiagnosaKerja1KeyPressed(evt);
            }
        });
        internalFrame2.add(JawabanDiagnosaKerja1);
        JawabanDiagnosaKerja1.setBounds(495, 20, 225, 23);

        label4.setText("Diagnosa Kerja :");
        label4.setName("label4"); // NOI18N
        internalFrame2.add(label4);
        label4.setBounds(401, 20, 90, 23);
        ...
        ChkInput.setPreferredSize(new java.awt.Dimension(330, 20));
        ...
        TanggalPermintaan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-11-2025 21:50:49" }));
        ...
        scrollPane1.setBounds(16, 200, 602, 170);
        ...
        BtnSimpan1.setText("Simpan Konsul");
        ...
        BtnSimpan1.setBounds(630, 340, 160, 30);
        ...
        BtnJawabanDikonsuli.setForeground(new java.awt.Color(255, 51, 51));
        BtnJawabanDikonsuli.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnJawabanDikonsuli.setText("Jawab Konsul");
        BtnJawabanDikonsuli.setFocusPainted(false);
        BtnJawabanDikonsuli.setFont(new java.awt.Font("Tahoma", 3, 11)); // NOI18N
        ...
        BtnKirimWhatsapp.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/wa.png"))); // NOI18N
        BtnKirimWhatsapp.setText("Kirim Whatsapp");
        BtnKirimWhatsapp.setFocusPainted(false);
        BtnKirimWhatsapp.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnKirimWhatsapp.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnKirimWhatsapp.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnKirimWhatsapp.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnKirimWhatsapp.setName("BtnKirimWhatsapp"); // NOI18N
        BtnKirimWhatsapp.setPreferredSize(new java.awt.Dimension(130, 23));
        BtnKirimWhatsapp.setRoundRect(false);
        BtnKirimWhatsapp.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnKirimWhatsappActionPerformed(evt);
            }
        });
        FormMenu.add(BtnKirimWhatsapp);
...
bukaJawabanKonsulOtomatis();
    ...
    private void BtnKirimWhatsappActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKirimWhatsappActionPerformed
        if(NoRw.getText().trim().equals("")||NoRM.getText().trim().equals("")||NmPasien.getText().trim().equals("")){
        ...
        try{
            String poli=Sequel.cariIsi(
                    "select poliklinik.nm_poli from reg_periksa inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli where reg_periksa.no_rawat=?",
                    NoRw.getText()
            );
            if(poli==null || poli.trim().equals("")){
                poli="-";
            }
            String dokter=NmDokterDikonsuli.getText().trim();
            if(dokter.equals("")){
                dokter=NmDokter.getText().trim();
            }
            if(dokter.equals("")){
                dokter=Sequel.cariIsi(
            ...
            if(dokter==null || dokter.trim().equals("")){
                dokter="-";
            }
            String noReg=NoPermintaan.getText().trim();
            if(noReg.equals("")){
                noReg=NoRw.getText().trim();
            }
            WhatsappKirimFonnte kirim=new WhatsappKirimFonnte(null,false);
            kirim.setNoRm(NoRM.getText(),noReg,poli,dokter,TanggalPermintaan.getDate());
    ...
    }//GEN-LAST:event_BtnKirimWhatsappActionPerformed
    ...
    private void BtnSimpanJawabanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanJawabanActionPerformed
        if(NoRw.getText().trim().equals("")||NoRM.getText().trim().equals("")||NmPasien.getText().trim().equals("")){
            ...
            Valid.textKosong(UraianKonsultasi,"Uraian Konsultasi");
        }else if(DiagnosaKerja1.getText().trim().equals("")){
            Valid.textKosong(DiagnosaKerja1,"Jawaban Diagnosa Kerja");
           ...
           JOptionPane.showMessageDialog(null,"Maaf, Dokter yang dikonsuli jangan diri sendiri...!");
            ...
            if(Sequel.menyimpantf("jawaban_konsultasi_medik","?,?,?,?",4,new String[]{
                    NoPermintaan.getText(),Valid.SetTgl(TanggalJawab.getSelectedItem()+"")+" "+TanggalJawab.getSelectedItem().toString().substring(11,19),DiagnosaKerja1.getText(),JawabanKonsultasi.getText()
                },"no_permintaan=?","tanggal=?,diagnosa_kerja=?,uraian_jawaban=?",4,new String[]{
                    Valid.SetTgl(TanggalJawab.getSelectedItem()+"")+" "+TanggalJawab.getSelectedItem().toString().substring(11,19),DiagnosaKerja1.getText(),JawabanKonsultasi.getText(),NoPermintaan.getText()
                })==true){
                    R2.setSelected(true);
                    tampil();
                    emptTeks();
    ...
    private void TanggalJawabKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TanggalJawabKeyPressed
        Valid.pindah(evt,BtnSimpanJawaban,DiagnosaKerja1);
    ...
    private void DiagnosaKerja1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DiagnosaKerja1KeyPressed
        Valid.pindah(evt,TanggalJawab,JawabanKonsultasi);
    }//GEN-LAST:event_DiagnosaKerja1KeyPressed

    private void UraianKonsultasi1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_UraianKonsultasi1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_UraianKonsultasi1KeyPressed

    private void JawabanDiagnosaKerja1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JawabanDiagnosaKerja1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_JawabanDiagnosaKerja1KeyPressed
    ...
    */
    ...
    private widget.Button BtnKirimWhatsapp;
    ...
    private widget.TextBox DiagnosaKerja1;
    private widget.PanelBiasa FormInput;
    private widget.PanelBiasa FormMenu;
    private widget.TextBox JawabanDiagnosaKerja1;
    ...
    private widget.TextArea UraianKonsultasi1;
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            DiagnosaKerja1.setText(tbObat.getValueAt(tbObat.getSelectedRow(),17).toString());
    ...
    public void isCek(){
        ...
        BtnKirimWhatsapp.setEnabled(akses.getkonsultasi_medik());
        if(akses.getjml2()>=1){
            KdDokter.setEditable(false);
   ...
   private void isMenu(){
    ...
    public void bukaJawabanKonsulOtomatis() {
        // Kalau tabel kosong
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        ...
        // Kalau belum ada baris yang dipilih, auto pilih baris pertama
        if (tbObat.getSelectedRow() == -1 && tbObat.getRowCount() > 0) {
            tbObat.setRowSelectionInterval(0, 0);
        }

        int sr = tbObat.getSelectedRow();
        if (sr == -1) {
            JOptionPane.showMessageDialog(null, "Maaf, silahkan pilih data...!!!!");
            return;
        }
        ...
        String noPermintaan = tbObat.getValueAt(sr, 0) != null ? tbObat.getValueAt(sr, 0).toString() : "";
        String kdDokterDikonsuli = tbObat.getValueAt(sr, 12) != null ? tbObat.getValueAt(sr, 12).toString() : "";
        String diagnosaAsal = tbObat.getValueAt(sr, 14) != null ? tbObat.getValueAt(sr, 14).toString() : "";
        String uraianAsal = tbObat.getValueAt(sr, 15) != null ? tbObat.getValueAt(sr, 15).toString() : "";

        if (!akses.getkode().equals("Admin Utama") && !kdDokterDikonsuli.equals(akses.getkode())) {
            JOptionPane.showMessageDialog(null, "Maaf, hanya bisa dijawab oleh dokter yang dikonsuli...!!!!");
            return;
        }

        NoPermintaanJawaban.setText(noPermintaan);
        WindowInput.setAlwaysOnTop(false);
        WindowInput.setVisible(true);

        UraianKonsultasi1.setText(uraianAsal);
        UraianKonsultasi1.setCaretPosition(0); // scroll ke atas
        DiagnosaKerja1.setText(diagnosaAsal);
        DiagnosaKerja1.setCaretPosition(0); // scroll ke atas
        DiagnosaKerja1.requestFocus();
    }

    public void bukaRiwayatJawabanKonsul() {
        R2.setSelected(true);
