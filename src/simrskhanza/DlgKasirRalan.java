...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    private javax.swing.Timer cariRefreshTimer;
    ...
    "Jam","No.Reg","Status Bayar","Stts Poli","Kd PJ","Kd Poli","No.Telp Pasien","No.SEP","Tgl.Lahir","No.KTP","Akhir Rujukan","Tgl.Kontrol Selanjutnya","Alamat Penanggung Jawab"}){ // Tambahkan "Akhir Rujukan"
      @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        ...
        tabModekasir2=new DefaultTableModel(null,new String[]{
            ...
            "Jenis Bayar","Status","No.Rawat","Tanggal","Jam","Kode Poli","Kode PJ","No.Telp Pasien","No. SEP","Tgl.Lahir","No.KTP","Akhir Rujukan","Tgl.Kontrol Selanjutnya","Alamat Penanggung Jawab"}){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        ...
        cariRefreshTimer = new javax.swing.Timer(300, (java.awt.event.ActionEvent e) -> {
            cariRefreshTimer.stop();
            TabRawatMouseClicked(null);
        });
        cariRefreshTimer.setRepeats(false);

        autoRefreshTimer = new javax.swing.Timer(180000, (java.awt.event.ActionEvent e) -> {
    ...
    private void initComponents() {
        ...
        TglBerakhirRujukan = new widget.TextBox();
        label1 = new widget.Label();
        BtnKonsul1 = new widget.Button();
        ...
        TglSakit1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-11-2025" }));
        ...
        TglSakit2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-11-2025" }));
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 102), 4), "::[DAFTAR PASIEN RAWAT JALAN]::", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Liberation Sans", 1, 18), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        panelGlass6.setWarnaAtas(new java.awt.Color(250, 250, 255));
        ...
        jLabel6.setBounds(6, 13, 70, 23);

        TCari.setFont(new java.awt.Font("Open Sans Semibold", 0, 11)); // NOI18N
        ...
        BtnCari.setBounds(390, 10, 70, 30);
        ...
        LCount.setBounds(751, 10, 100, 30);
        ...
        CrPoli.setFont(new java.awt.Font("Open Sans Semibold", 0, 11)); // NOI18N
        CrPoli.setName("CrPoli"); // NOI18N
        CrPoli.setPreferredSize(new java.awt.Dimension(280, 23));
        panelGlass7.add(CrPoli);

        BtnSeek4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/20paper.png"))); // NOI18N
        ...
        panelGlass8.setWarnaAtas(new java.awt.Color(250, 250, 255));
        panelGlass8.setWarnaBawah(new java.awt.Color(250, 250, 255));
        ...
        DTPCari1.setBounds(81, 13, 90, 23);
        ...
        jLabel17.setBounds(176, 13, 23, 23);
        ...
        DTPCari2.setBounds(204, 13, 90, 23);

        jLabel12.setText("Status Periksa :");
        jLabel12.setFont(new java.awt.Font("Open Sans Semibold", 0, 11)); // NOI18N
        jLabel12.setName("jLabel12"); // NOI18N
        jLabel12.setPreferredSize(new java.awt.Dimension(120, 23));
        panelGlass8.add(jLabel12);
        jLabel12.setBounds(299, 13, 120, 23);
        ...
        cmbStatus.setBounds(424, 13, 150, 23);
        ...
        jLabel20.setBounds(579, 13, 120, 23);
        ...
        cmbStatusBayar.setBounds(704, 13, 150, 23);

        ChkAutoRefresh.setText("Auto refresh 3 menit");
        ChkAutoRefresh.setName("ChkAutoRefresh"); // NOI18N
        ChkAutoRefresh.setPreferredSize(new java.awt.Dimension(150, 23));
        ChkAutoRefresh.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ChkAutoRefreshActionPerformed(evt);
            }
        });
        panelGlass8.add(ChkAutoRefresh);
        ChkAutoRefresh.setBounds(864, 13, 150, 23);

        jPanel2.add(panelGlass8, java.awt.BorderLayout.PAGE_START);

        internalFrame1.add(jPanel2, java.awt.BorderLayout.PAGE_END);

        TabRawat.setBackground(new java.awt.Color(250, 250, 255));
        TabRawat.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        TabRawat.setForeground(new java.awt.Color(50, 50, 50));
        TabRawat.setFont(new java.awt.Font("Liberation Sans", 0, 12)); // NOI18N
        ...
        Scroll1.setBackground(new java.awt.Color(250, 250, 255));
        ...
        Scroll1.setFont(new java.awt.Font("Liberation Sans", 0, 14)); // NOI18N
        ...
        tbKasirRalan.setFont(new java.awt.Font("Liberation Sans", 1, 12)); // NOI18N
        ...
        Scroll2.setBackground(new java.awt.Color(250, 250, 255));
        ...
        panelGlass9.setWarnaAtas(new java.awt.Color(250, 250, 255));
        panelGlass9.setWarnaBawah(new java.awt.Color(250, 250, 255));
        ...
        TNoRwCari.setFont(new java.awt.Font("Open Sans Semibold", 0, 12)); // NOI18N
        ...
        TNoRwCari.setBounds(80, 10, 160, 23);

        jLabel5.setText("No. Reg. :");
        jLabel5.setFont(new java.awt.Font("Open Sans Semibold", 0, 11)); // NOI18N
        jLabel5.setName("jLabel5"); // NOI18N
        jLabel5.setPreferredSize(new java.awt.Dimension(70, 23));
        panelGlass9.add(jLabel5);
        jLabel5.setBounds(230, 10, 70, 23);

        TNoReg.setEditable(false);
        TNoReg.setFont(new java.awt.Font("Open Sans Semibold", 0, 12)); // NOI18N
        ...
        jLabel7.setBounds(360, 10, 65, 23);

        TNoRMCari.setEditable(false);
        TNoRMCari.setFont(new java.awt.Font("Open Sans Semibold", 1, 12)); // NOI18N
        ...
        TNoRMCari.setBounds(430, 10, 90, 23);
        ...
        jLabel8.setBounds(520, 10, 85, 23);

        TPasienCari.setEditable(false);
        TPasienCari.setFont(new java.awt.Font("Open Sans Semibold", 1, 12)); // NOI18N
        ...
        TPasienCari.setBounds(610, 10, 255, 23);

        TNoKTP.setEditable(false);
        TNoKTP.setFont(new java.awt.Font("Open Sans Semibold", 0, 12)); // NOI18N
        TNoKTP.setHighlighter(null);
        TNoKTP.setName("TNoKTP"); // NOI18N
        TNoKTP.setPreferredSize(new java.awt.Dimension(250, 23));
        panelGlass9.add(TNoKTP);
        TNoKTP.setBounds(1130, 190, 200, 23);

        jLabel9.setText("No. KTP :");
        jLabel9.setFont(new java.awt.Font("Open Sans Semibold", 0, 11)); // NOI18N
        jLabel9.setName("jLabel9"); // NOI18N
        jLabel9.setPreferredSize(new java.awt.Dimension(85, 23));
        panelGlass9.add(jLabel9);
        jLabel9.setBounds(1040, 190, 85, 23);

        Btn5Soap1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/logo npjs(1).png"))); // NOI18N
        Btn5Soap1.setMnemonic('4');
        Btn5Soap1.setText("Kontrol BPJS");
        Btn5Soap1.setToolTipText("ALt+4");
        Btn5Soap1.setFocusTraversalPolicyProvider(true);
        Btn5Soap1.setFont(new java.awt.Font("Liberation Sans", 1, 12)); // NOI18N
        Btn5Soap1.setGlassColor(new java.awt.Color(230, 226, 226));
        ...
        panelGlass9.add(Btn5Soap1);
        Btn5Soap1.setBounds(20, 40, 130, 30);

        Btn5Soap2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/icaree.png"))); // NOI18N
        Btn5Soap2.setMnemonic('4');
        Btn5Soap2.setText("iCare BPJS");
        Btn5Soap2.setToolTipText("ALt+4");
        Btn5Soap2.setFont(new java.awt.Font("Liberation Sans", 1, 12)); // NOI18N
        Btn5Soap2.setGlassColor(new java.awt.Color(230, 226, 226));
        ...
        panelGlass9.add(Btn5Soap2);
        Btn5Soap2.setBounds(160, 40, 151, 30);

        BtnKonsul.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/rme7.png"))); // NOI18N
        BtnKonsul.setMnemonic('4');
        BtnKonsul.setText("Jawab Konsul");
        BtnKonsul.setToolTipText("ALt+4");
        BtnKonsul.setFont(new java.awt.Font("Liberation Sans", 1, 12)); // NOI18N
        BtnKonsul.setGlassColor(new java.awt.Color(230, 226, 226));
        ...
        panelGlass9.add(BtnKonsul);
        BtnKonsul.setBounds(510, 40, 151, 30);

        BtnSEP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/logo npjs(1).png"))); // NOI18N
        BtnSEP.setMnemonic('4');
        BtnSEP.setText("Lihat SEP");
        BtnSEP.setToolTipText("ALt+4");
        BtnSEP.setFont(new java.awt.Font("Liberation Sans", 1, 12)); // NOI18N
        BtnSEP.setGlassColor(new java.awt.Color(230, 226, 226));
        ...
        panelGlass9.add(BtnSEP);
        BtnSEP.setBounds(670, 40, 130, 30);

        NoSEP1.setEditable(false);
        NoSEP1.setFont(new java.awt.Font("Open Sans Semibold", 0, 12)); // NOI18N
        NoSEP1.setHighlighter(null);
        NoSEP1.setName("NoSEP1"); // NOI18N
        NoSEP1.setPreferredSize(new java.awt.Dimension(250, 23));
        panelGlass9.add(NoSEP1);
        NoSEP1.setBounds(850, 190, 200, 23);

        jLabel11.setText("No. SEP :");
        jLabel11.setFont(new java.awt.Font("Open Sans Semibold", 0, 11)); // NOI18N
        jLabel11.setName("jLabel11"); // NOI18N
        jLabel11.setPreferredSize(new java.awt.Dimension(85, 23));
        panelGlass9.add(jLabel11);
        jLabel11.setBounds(790, 190, 60, 23);

        TglBerakhirRujukan.setName("TglBerakhirRujukan"); // NOI18N
        panelGlass9.add(TglBerakhirRujukan);
        TglBerakhirRujukan.setBounds(1000, 10, 120, 20);

        label1.setText("Rujukan Berkahir :");
        label1.setName("label1"); // NOI18N
        panelGlass9.add(label1);
        label1.setBounds(900, 3, 100, 30);

        BtnKonsul1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/rme22.png"))); // NOI18N
        BtnKonsul1.setMnemonic('4');
        BtnKonsul1.setText("Permintaan Konsul");
        BtnKonsul1.setToolTipText("ALt+4");
        BtnKonsul1.setFont(new java.awt.Font("Liberation Sans", 1, 12)); // NOI18N
        BtnKonsul1.setGlassColor(new java.awt.Color(230, 226, 226));
        BtnKonsul1.setName("BtnKonsul1"); // NOI18N
        BtnKonsul1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnKonsul1ActionPerformed(evt);
            }
        });
        panelGlass9.add(BtnKonsul1);
        BtnKonsul1.setBounds(320, 40, 180, 30);
    ...
    private void BtnAllKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnAllKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt, TCari, BtnKonsul);
        }
    ...
    private void requestCariRefresh() {
    ...
    private void ChkAutoRefreshActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkAutoRefreshActionPerformed
        setAutoRefreshEnabled(ChkAutoRefresh.isSelected());
...
private void MnDataPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatActionPerformed
    ...
    private void ppMasukPerawatBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppMasukPerawatBtnPrintActionPerformed
        if(tabModekasir.getRowCount()==0){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                Sequel.queryu("delete from antripoli_perawat where kd_dokter='"+tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString()+"' and kd_poli='"+tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),18).toString()+"'");
                Sequel.queryu("insert into antripoli_perawat values('"+tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString()+"','"+tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),18).toString()+"','1','"+tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),11).toString()+"')");
            }
        }
    ...
    private void BtnKonsulActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKonsulActionPerformed
        if (TabRawat.getSelectedIndex() == 1) {
            if (tabModekasir2.getRowCount() == 0) {
                ...
                if (tbKasirRalan2.getSelectedRow() == -1 && tbKasirRalan2.getRowCount() > 0) {
                    tbKasirRalan2.setRowSelectionInterval(0, 0);
                }
                if (tbKasirRalan2.getSelectedRow() != -1) {
                    getDatakasir2();
                }
                ...
                if (tbKasirRalan2.getSelectedRow() != -1) {
                    ...
                    form.tampil();
                    form.setVisible(true);
                    form.bukaJawabanKonsulOtomatis();
        ...
        if (tabModekasir.getRowCount() == 0) {
            ...
            if (tbKasirRalan.getSelectedRow() == -1 && tbKasirRalan.getRowCount() > 0) {
                tbKasirRalan.setRowSelectionInterval(0, 0);
            }
            if (tbKasirRalan.getSelectedRow() != -1) {
                getDatakasir();
            }
            ...
            if (tbKasirRalan.getSelectedRow() != -1) {
                ...
                form.emptTeks();
                // Kirim No.Rawat & data pasien seperti biasa
                form.setNoRm(TNoRw.getText(), TNoRMCari.getText(), TPasienCari.getText());
                form.tampil();                 // load daftar permintaan konsul pasien ini
                form.setVisible(true);         // tampilkan DlgPermintaanKonsultasiMedik

                // ⬇⬇⬇ INI BAGIAN PENTING: LANGSUNG BUKA JAWABAN KONSUL
                form.bukaJawabanKonsulOtomatis();
...
this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
    ...
    private void BtnKonsul1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKonsul1ActionPerformed
        if (TabRawat.getSelectedIndex() == 1) {
            if(tabModekasir2.getRowCount()==0){
                JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
                TCari.requestFocus();
    ...
    }//GEN-LAST:event_BtnKonsul1ActionPerformed
    ...
    */
    ...
    private widget.Button BtnKonsul1;
    ...
    private widget.TextBox TglBerakhirRujukan;
    ...
    private javax.swing.JMenuItem MnPenilaianPreInduksi,MnHasilPemeriksaanUSGUrologi,MnHasilPemeriksaanUSGGynecologi,MnPaketMCU,MnJawabLembarKonsul,MnPemantauanIntradialitik,MnHasilPemeriksaanEcho,MnPenilaianPasienImunitasRendah,
            MnCatatanKeseimbanganCairan,MnCatatanObservasiCHBP,MnPenilaianAwalKeperawatanHemodialisa;
    ...
    try{   
        ...
        pskasir=koneksi.prepareStatement("select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,"+
            "reg_periksa.kd_dokter,dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,poliklinik.nm_poli,"+
            "reg_periksa.p_jawab,reg_periksa.almt_pj,reg_periksa.hubunganpj,reg_periksa.biaya_reg,reg_periksa.stts,penjab.png_jawab,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur, "+
            "reg_periksa.status_bayar,reg_periksa.status_poli,reg_periksa.kd_pj,reg_periksa.kd_poli,pasien.no_tlp,IF(bridging_sep.no_sep IS NULL,'-',bridging_sep.no_sep) as no_sep,pasien.tgl_lahir,pasien.no_ktp, "+
            "IFNULL(DATE_FORMAT(DATE_ADD(bridging_sep.tglrujukan, INTERVAL 90 DAY), '%d-%m-%Y'),'-') as tgl_akhir_rujukan, "+
            "IFNULL(DATE_FORMAT(surat_kontrol.tgl_kontrol_selanjutnya, '%d-%m-%Y'),'-') as tgl_kontrol_selanjutnya "+ // Mengambil tanggal kontrol selanjutnya per pasien
            "from reg_periksa inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
            ...
            "left join ("+
                "select rp.no_rkm_medis,min(bsk.tgl_rencana) as tgl_kontrol_selanjutnya "+
                "from bridging_surat_kontrol_bpjs bsk "+
                "inner join bridging_sep bs on bsk.no_sep=bs.no_sep "+
                "inner join reg_periksa rp on bs.no_rawat=rp.no_rawat "+
                "where bsk.tgl_rencana>=current_date() "+
                "group by rp.no_rkm_medis"+
            ") surat_kontrol on surat_kontrol.no_rkm_medis=reg_periksa.no_rkm_medis where "+ // Join tanggal kontrol selanjutnya per pasien
        ...
        try{
            ...
            while(rskasir.next()){
                tabModekasir.addRow(new String[] {
                    ...
                    rskasir.getString("kd_pj"),rskasir.getString("kd_poli"),rskasir.getString("no_tlp"),rskasir.getString("no_sep"),rskasir.getString("tgl_lahir"),rskasir.getString("no_ktp"),
                    rskasir.getString("tgl_akhir_rujukan"),rskasir.getString("tgl_kontrol_selanjutnya"),rskasir.getString(11)
                });
            }                
        } catch(Exception e){
    ...
    private void tampilkasir2() {                   
        ...
        try{   
            ...
            pskasir=koneksi.prepareStatement("select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,"+
                ...
                "reg_periksa.p_jawab,reg_periksa.almt_pj,reg_periksa.hubunganpj,reg_periksa.stts,penjab.png_jawab,rujukan_internal_poli.kd_poli,IF(bridging_sep.no_sep IS NULL,'-',bridging_sep.no_sep) as no_sep,pasien.tgl_lahir,pasien.no_ktp, "+
                "IFNULL(DATE_FORMAT(DATE_ADD(bridging_sep.tglrujukan, INTERVAL 90 DAY), '%d-%m-%Y'),'-') as tgl_akhir_rujukan, "+
                "IFNULL(DATE_FORMAT(surat_kontrol.tgl_kontrol_selanjutnya, '%d-%m-%Y'),'-') as tgl_kontrol_selanjutnya, "+
                ...
                "left join ("+
                    ...
                    "where bsk.tgl_rencana>=current_date() "+
                    "group by rp.no_rkm_medis"+
                ") surat_kontrol on surat_kontrol.no_rkm_medis=reg_periksa.no_rkm_medis where "+
                "reg_periksa.status_lanjut='Ralan' and reg_periksa.tgl_registrasi between ? and ? "+
            ...
            try{
                ...
                while(rskasir.next()){
                    tabModekasir2.addRow(new String[] {
                        ...
                        rskasir.getString("jam_reg"),rskasir.getString("kd_poli"),rskasir.getString("kd_pj"),rskasir.getString("no_tlp"),rskasir.getString("no_sep"),rskasir.getString("tgl_lahir"),rskasir.getString("no_ktp"),
                        rskasir.getString("tgl_akhir_rujukan"),rskasir.getString("tgl_kontrol_selanjutnya"),rskasir.getString("almt_pj")
                    });
                }                
            } catch(Exception e){
                System.out.println("Notifikasi : "+e);
    ...
    private void getDatakasir() {
        if(tbKasirRalan.getSelectedRow()!= -1){
            ...
            TglBerakhirRujukan.setText(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 23).toString()); 
            ...
            Sequel.cariIsi("select bridging_sep.no_sep from bridging_sep where bridging_sep.no_rawat=? ",TNoKTP,TNoRw.getText());
