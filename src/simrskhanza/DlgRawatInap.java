...
import grafikanalisa.grafikttv;
...
public final class DlgRawatInap extends javax.swing.JDialog {
    ...
    private final DefaultTableModel tabModeDr, tabModePr, tabModeDrPr,
            tabModePemeriksaan, tabModeObstetri, tabModeGinekologi, tabModePemeriksaanAdime;
    ...
    public DlgRawatInap(java.awt.Frame parent, boolean modal) {
        ...
        tabModePemeriksaan = new DefaultTableModel(null, new Object[]{
            ...
            "Instruksi", "Evaluasi", "NIP", "Dokter/Paramedis", "Profesi/Jabatan", "Status"}) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                boolean a = false;
                if (colIndex == 0) {
...
//                        KdPeg4.requestFocus();                    
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 102), 3), "::[ Perawatan/Tindakan Rawat Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Liberation Sans", 1, 18), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TabRawat.setFont(new java.awt.Font("Liberation Sans", 1, 12)); // NOI18N
        ...
        jLabel15.setBounds(720, 280, 90, 23);
        ...
        TAlergi.setBounds(810, 280, 360, 23);
        ...
        TKeluhan.setRows(5);
        TKeluhan.setFont(new java.awt.Font("Liberation Sans", 0, 12)); // NOI18N
        ...
        scrollPane1.setBounds(20, 60, 360, 110);
        ...
        TPemeriksaan.setFont(new java.awt.Font("Liberation Sans", 0, 12)); // NOI18N
        ...
        scrollPane2.setBounds(20, 190, 360, 110);
        ...
        jLabel9.setFont(new java.awt.Font("Liberation Sans", 1, 11)); // NOI18N
        jLabel9.setName("jLabel9"); // NOI18N
        panelGlass12.add(jLabel9);
        jLabel9.setBounds(10, 170, 70, 23);
        ...
        TPenilaian.setFont(new java.awt.Font("Liberation Sans", 0, 12)); // NOI18N
        ...
        scrollPane3.setBounds(390, 60, 360, 110);

        jLabel37.setText("Asesmen :");
        jLabel37.setFont(new java.awt.Font("Liberation Sans", 1, 11)); // NOI18N
        jLabel37.setName("jLabel37"); // NOI18N
        panelGlass12.add(jLabel37);
        jLabel37.setBounds(360, 40, 90, 23);

        jLabel26.setText("Plan :");
        jLabel26.setFont(new java.awt.Font("Liberation Sans", 1, 11)); // NOI18N
        jLabel26.setName("jLabel26"); // NOI18N
        panelGlass12.add(jLabel26);
        jLabel26.setBounds(340, 170, 90, 23);
        ...
        TindakLanjut.setFont(new java.awt.Font("Liberation Sans", 0, 12)); // NOI18N
        ...
        scrollPane4.setBounds(390, 190, 360, 110);

        jLabel53.setText("Dilakukan :");
        jLabel53.setName("jLabel53"); // NOI18N
        panelGlass12.add(jLabel53);
        jLabel53.setBounds(10, 10, 70, 23);
        ...
        TInstruksi.setFont(new java.awt.Font("Liberation Sans", 0, 12)); // NOI18N
        ...
        scrollPane7.setBounds(760, 60, 360, 110);

        jLabel56.setText("SpO2 (%) :");
        jLabel56.setName("jLabel56"); // NOI18N
        panelGlass12.add(jLabel56);
        jLabel56.setBounds(750, 250, 70, 23);
        ...
        SpO2.setBounds(820, 250, 42, 23);

        jLabel22.setText("GCS (E,V,M) :");
        jLabel22.setName("jLabel22"); // NOI18N
        panelGlass12.add(jLabel22);
        jLabel22.setBounds(870, 250, 70, 23);
        ...
        TGCS.setBounds(940, 250, 42, 23);

        jLabel58.setText("Kesadaran :");
        jLabel58.setName("jLabel58"); // NOI18N
        panelGlass12.add(jLabel58);
        jLabel58.setBounds(980, 250, 70, 23);
        ...
        cmbKesadaran.setBounds(1060, 250, 126, 23);
        ...
        scrollPane8.setBounds(1220, 790, 360, 44);

        jLabel59.setText("Evaluasi :");
        jLabel59.setName("jLabel59"); // NOI18N
        panelGlass12.add(jLabel59);
        jLabel59.setBounds(1130, 790, 90, 23);
        ...
        Btn5Soap.setBounds(690, 810, 28, 23);

        jLabel7.setText("Suhu (°C) :");
        jLabel7.setName("jLabel7"); // NOI18N
        panelGlass12.add(jLabel7);
        jLabel7.setBounds(750, 190, 70, 23);
        ...
        TSuhu.setBounds(820, 190, 55, 23);

        jLabel17.setText("TB (Cm) :");
        jLabel17.setName("jLabel17"); // NOI18N
        panelGlass12.add(jLabel17);
        jLabel17.setBounds(750, 220, 70, 23);
        ...
        TTinggi.setBounds(820, 220, 55, 23);

        jLabel4.setText("Tensi (mmHg) :");
        jLabel4.setName("jLabel4"); // NOI18N
        panelGlass12.add(jLabel4);
        jLabel4.setBounds(880, 190, 90, 23);
        ...
        TTensi.setBounds(970, 190, 74, 23);
        ...
        TBerat.setBounds(1130, 190, 55, 23);
        ...
        TNadi.setBounds(1130, 220, 55, 23);

        jLabel61.setText("Nadi (/menit) :");
        jLabel61.setName("jLabel61"); // NOI18N
        panelGlass12.add(jLabel61);
        jLabel61.setBounds(1050, 220, 79, 23);

        BtnInputKonsul.setForeground(new java.awt.Color(0, 0, 0));
        BtnInputKonsul.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/rme22.png"))); // NOI18N
        BtnInputKonsul.setMnemonic('4');
        BtnInputKonsul.setText("Konsulatasi Medis");
        BtnInputKonsul.setToolTipText("");
        BtnInputKonsul.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        BtnInputKonsul.setGlassColor(new java.awt.Color(0, 153, 0));
        ...
        BtnInputKonsul.setBounds(1190, 130, 160, 30);
        ...
        BtnInputKonsul1.setBounds(930, 770, 160, 30);
        ...
        BtnInputJadwalOP1.setBounds(930, 800, 160, 30);
        ...
        BtnTemplateResep.setBounds(930, 690, 160, 30);
        ...
        BtnTemplatePemberianObat.setBounds(930, 730, 160, 30);
        ...
        BtnBalanceCairan.setBounds(270, 770, 160, 30);
        ...
        BtnVerifSbar5.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        BtnVerifSbar5.setGlassColor(new java.awt.Color(0, 153, 0));
        ...
        BtnVerifSbar5.setBounds(1360, 10, 160, 26);
        ...
        Btn5Soap1.setText("Lihat Riwayat SOAP");
        Btn5Soap1.setToolTipText("");
        Btn5Soap1.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        Btn5Soap1.setGlassColor(new java.awt.Color(0, 153, 0));
        ...
        Btn5Soap1.setBounds(1190, 10, 160, 26);
        ...
        Btn5Soap2.setText("Copy RESEP");
        Btn5Soap2.setToolTipText("");
        Btn5Soap2.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        Btn5Soap2.setGlassColor(new java.awt.Color(0, 153, 0));
        ...
        Btn5Soap2.setBounds(1360, 40, 160, 26);

        BtnRwytLab.setForeground(new java.awt.Color(0, 0, 0));
        BtnRwytLab.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/TestTubes.png"))); // NOI18N
        BtnRwytLab.setMnemonic('4');
        BtnRwytLab.setText("Riwayat Laboratorium");
        BtnRwytLab.setToolTipText("");
        BtnRwytLab.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        BtnRwytLab.setGlassColor(new java.awt.Color(0, 153, 0));
        BtnRwytLab.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnRwytLab.setName("BtnRwytLab"); // NOI18N
        BtnRwytLab.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnRwytLabActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnRwytLab);
        BtnRwytLab.setBounds(1360, 100, 160, 26);

        BtnHasilPengobatan1.setForeground(new java.awt.Color(0, 0, 0));
        BtnHasilPengobatan1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/rme15.png"))); // NOI18N
        BtnHasilPengobatan1.setMnemonic('4');
        BtnHasilPengobatan1.setText("Order Radiologi");
        BtnHasilPengobatan1.setToolTipText("");
        BtnHasilPengobatan1.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        BtnHasilPengobatan1.setGlassColor(new java.awt.Color(0, 153, 0));
        ...
        BtnHasilPengobatan1.setBounds(1190, 70, 160, 26);
        ...
        BtnRiwayatKonsulDPJP.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        BtnRiwayatKonsulDPJP.setGlassColor(new java.awt.Color(0, 153, 0));
        ...
        BtnRiwayatKonsulDPJP.setBounds(1360, 130, 160, 26);
        ...
        BtnRiwayatSBAR.setBounds(100, 790, 160, 26);

        BtnVerifSbar4.setForeground(new java.awt.Color(0, 0, 0));
        BtnVerifSbar4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/peminjaman.png"))); // NOI18N
        BtnVerifSbar4.setMnemonic('4');
        BtnVerifSbar4.setText("Validasi SBAR");
        BtnVerifSbar4.setToolTipText("ALt+4");
        BtnVerifSbar4.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnVerifSbar4.setGlassColor(new java.awt.Color(0, 0, 255));
        BtnVerifSbar4.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnVerifSbar4.setName("BtnVerifSbar4"); // NOI18N
        BtnVerifSbar4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnVerifSbar4ActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnVerifSbar4);
        BtnVerifSbar4.setBounds(100, 820, 160, 26);
        ...
        BtnJawabKonsulDPJP.setBounds(280, 850, 160, 26);

        BtnStatsVerifikasiSoap.setForeground(new java.awt.Color(0, 0, 0));
        BtnStatsVerifikasiSoap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Bar Chart.png"))); // NOI18N
        BtnStatsVerifikasiSoap.setMnemonic('4');
        BtnStatsVerifikasiSoap.setText("Status Verifikasi SOAP");
        BtnStatsVerifikasiSoap.setToolTipText("");
        BtnStatsVerifikasiSoap.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        BtnStatsVerifikasiSoap.setGlassColor(new java.awt.Color(0, 153, 0));
        BtnStatsVerifikasiSoap.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnStatsVerifikasiSoap.setName("BtnStatsVerifikasiSoap"); // NOI18N
        BtnStatsVerifikasiSoap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnStatsVerifikasiSoapActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnStatsVerifikasiSoap);
        BtnStatsVerifikasiSoap.setBounds(1360, 160, 160, 30);
        ...
        BtnDicom.setBounds(1310, 350, 200, 26);
        ...
        Status.setBounds(530, 10, 126, 23);

        jLabel116.setText("Status:");
        jLabel116.setFont(new java.awt.Font("Tahoma", 3, 11)); // NOI18N
        jLabel116.setName("jLabel116"); // NOI18N
        panelGlass12.add(jLabel116);
        jLabel116.setBounds(450, 10, 70, 23);

        Btn5Soap4.setForeground(new java.awt.Color(0, 0, 0));
        Btn5Soap4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/pills-5-32x32.png"))); // NOI18N
        Btn5Soap4.setMnemonic('4');
        Btn5Soap4.setText("Input RESEP");
        Btn5Soap4.setToolTipText("");
        Btn5Soap4.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        Btn5Soap4.setGlassColor(new java.awt.Color(0, 153, 0));
        Btn5Soap4.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ...
        Btn5Soap4.setBounds(1190, 40, 160, 26);

        BtnLihatHasil.setForeground(new java.awt.Color(0, 0, 0));
        BtnLihatHasil.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Surgeon SH.png"))); // NOI18N
        BtnLihatHasil.setMnemonic('4');
        BtnLihatHasil.setText("Riwayat Radiologi");
        BtnLihatHasil.setToolTipText("");
        BtnLihatHasil.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        BtnLihatHasil.setGlassColor(new java.awt.Color(0, 153, 0));
        ...
        panelGlass12.add(BtnLihatHasil);
        BtnLihatHasil.setBounds(1360, 70, 160, 26);

        BtnHasilPengobatan3.setForeground(new java.awt.Color(0, 0, 0));
        BtnHasilPengobatan3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/rme14.png"))); // NOI18N
        BtnHasilPengobatan3.setMnemonic('4');
        BtnHasilPengobatan3.setText("Order LAB");
        BtnHasilPengobatan3.setToolTipText("");
        BtnHasilPengobatan3.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        BtnHasilPengobatan3.setGlassColor(new java.awt.Color(0, 153, 0));
        BtnHasilPengobatan3.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnHasilPengobatan3.setName("BtnHasilPengobatan3"); // NOI18N
        BtnHasilPengobatan3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnHasilPengobatan3ActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnHasilPengobatan3);
        BtnHasilPengobatan3.setBounds(1190, 100, 160, 26);

        BtnBalanceCairan2.setForeground(new java.awt.Color(0, 0, 0));
        BtnBalanceCairan2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Bar Chart.png"))); // NOI18N
        BtnBalanceCairan2.setMnemonic('4');
        BtnBalanceCairan2.setText("Grafik TTV");
        BtnBalanceCairan2.setToolTipText("");
        BtnBalanceCairan2.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        BtnBalanceCairan2.setGlassColor(new java.awt.Color(0, 153, 0));
        BtnBalanceCairan2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnBalanceCairan2.setName("BtnBalanceCairan2"); // NOI18N
        BtnBalanceCairan2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnBalanceCairan2ActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnBalanceCairan2);
        BtnBalanceCairan2.setBounds(1360, 250, 160, 30);

        BtnBalanceCairan3.setForeground(new java.awt.Color(0, 0, 0));
        BtnBalanceCairan3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Bar Chart.png"))); // NOI18N
        BtnBalanceCairan3.setMnemonic('4');
        BtnBalanceCairan3.setText("Status HandOver");
        BtnBalanceCairan3.setToolTipText("");
        BtnBalanceCairan3.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        BtnBalanceCairan3.setGlassColor(new java.awt.Color(0, 153, 0));
        BtnBalanceCairan3.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnBalanceCairan3.setName("BtnBalanceCairan3"); // NOI18N
        BtnBalanceCairan3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnBalanceCairan3ActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnBalanceCairan3);
        BtnBalanceCairan3.setBounds(1360, 220, 160, 30);

        BtnVerifikasiSoap.setForeground(new java.awt.Color(0, 0, 0));
        BtnVerifikasiSoap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/palli17.png"))); // NOI18N
        BtnVerifikasiSoap.setMnemonic('4');
        BtnVerifikasiSoap.setText("Verifikasi SOAP");
        BtnVerifikasiSoap.setToolTipText("");
        BtnVerifikasiSoap.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        BtnVerifikasiSoap.setGlassColor(new java.awt.Color(0, 153, 0));
        ...
        BtnVerifikasiSoap.setBounds(1190, 160, 160, 30);

        BtnBalanceCairan5.setForeground(new java.awt.Color(0, 0, 0));
        BtnBalanceCairan5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/rme5.png"))); // NOI18N
        BtnBalanceCairan5.setMnemonic('4');
        BtnBalanceCairan5.setText("HandOver Pasien");
        BtnBalanceCairan5.setToolTipText("");
        BtnBalanceCairan5.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        BtnBalanceCairan5.setGlassColor(new java.awt.Color(0, 153, 0));
        BtnBalanceCairan5.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnBalanceCairan5.setName("BtnBalanceCairan5"); // NOI18N
        BtnBalanceCairan5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnBalanceCairan5ActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnBalanceCairan5);
        BtnBalanceCairan5.setBounds(1190, 220, 160, 30);

        BtnValidasiSBAR.setForeground(new java.awt.Color(0, 0, 0));
        BtnValidasiSBAR.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/palli17.png"))); // NOI18N
        BtnValidasiSBAR.setMnemonic('4');
        BtnValidasiSBAR.setText("Verifikasi SBAR");
        BtnValidasiSBAR.setToolTipText("");
        BtnValidasiSBAR.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        BtnValidasiSBAR.setGlassColor(new java.awt.Color(0, 153, 0));
        ...
        panelGlass12.add(BtnValidasiSBAR);
        BtnValidasiSBAR.setBounds(1190, 190, 160, 30);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-11-2025" }));
        ...
        BtnRiwayat.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnResepObat.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnCopyResep.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPermintaanStok.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        BtnPermintaanStok.setText("Permintaan Stok Pasien");
        BtnPermintaanStok.setFocusPainted(false);
        BtnPermintaanStok.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPermintaanResepPulang.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        BtnPermintaanResepPulang.setText("Permintaan Resep Pulang");
        BtnPermintaanResepPulang.setFocusPainted(false);
        BtnPermintaanResepPulang.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnInputObat.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnObatBhp.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnBerkasDigital.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPermintaanLab.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPermintaanRad.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnJadwalOperasi.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnSKDP.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnRujukKeluar.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnDiagnosa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        BtnDiagnosa.setText("Diagnosa");
        BtnDiagnosa.setFocusPainted(false);
        BtnDiagnosa.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnResume.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnAwalKeperawatanUmum.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        BtnAwalKeperawatanUmum.setText("Awal Keperawatan Umum");
        BtnAwalKeperawatanUmum.setFocusPainted(false);
        BtnAwalKeperawatanUmum.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnAwalKeperawatanKandungan.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnAwalFisioterapi.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnAwalMedis.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnAwalMedisKandungan.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnAwalMedisHemodialisa.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnChecklistPreOperasi.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnSignInSebelumAnestesi.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnTimeOutSebelumInsisi.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnSignOutSebelumMenutupLuka.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnChecklistPostOperasi.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPenilaianPreOperasi.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPenilaianPreAnestesi.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnSkorAldrettePascaAnestesi.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnSkorStewardPascaAnestesi.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPenilaianPsikolog.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPerencanaanPemulangan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        BtnPerencanaanPemulangan.setText("Perencanaan Pemulangan");
        BtnPerencanaanPemulangan.setFocusPainted(false);
        BtnPerencanaanPemulangan.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPenilaianLanjutanResikoJatuhDewasa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        ...
        BtnPenilaianLanjutanResikoJatuhDewasa.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPenilaianLanjutanResikoJatuhAnak.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        ...
        BtnPenilaianLanjutanResikoJatuhAnak.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPenilaianLanjutanResikoJatuhLansia.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        ...
        BtnPenilaianLanjutanResikoJatuhLansia.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPenilaianLanjutanResikoJatuhNeonatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        ...
        BtnPenilaianLanjutanResikoJatuhNeonatus.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPenilaianLanjutanResikoJatuhGeriatri.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        ...
        BtnPenilaianLanjutanResikoJatuhGeriatri.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPenilaianLanjutanResikoJatuhPsikiatri.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        ...
        BtnPenilaianLanjutanResikoJatuhPsikiatri.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPenilaianLanjutanSkriningFungsional.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPenilaianResikoDekubitus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        BtnPenilaianResikoDekubitus.setText("Risiko Dekubitus");
        BtnPenilaianResikoDekubitus.setFocusPainted(false);
        BtnPenilaianResikoDekubitus.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnHasilPemeriksaanUSG.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnDokumentasiESWL.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnCatatanPersalinan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        BtnCatatanPersalinan.setText("Catatan Persalinan");
        BtnCatatanPersalinan.setFocusPainted(false);
        BtnCatatanPersalinan.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnCatatan.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnCatatanObservasiRanap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        BtnCatatanObservasiRanap.setText("Observasi Ranap");
        BtnCatatanObservasiRanap.setFocusPainted(false);
        BtnCatatanObservasiRanap.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnCatatanObservasiRanapKebidanan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        BtnCatatanObservasiRanapKebidanan.setText("Observasi Kebidanan");
        BtnCatatanObservasiRanapKebidanan.setFocusPainted(false);
        BtnCatatanObservasiRanapKebidanan.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnCatatanObservasiRanapPostPartum.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        BtnCatatanObservasiRanapPostPartum.setText("Observasi Post Partum");
        BtnCatatanObservasiRanapPostPartum.setFocusPainted(false);
        BtnCatatanObservasiRanapPostPartum.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnFollowUpDBD.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        BtnFollowUpDBD.setText("Follow Up DBD");
        BtnFollowUpDBD.setFocusPainted(false);
        BtnFollowUpDBD.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnCatatanKeperawatan.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnCatatanCekGDS.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPenilaianUlangNyeri.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPemantauanPEWSAnak.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPemantauanPEWSDewasa.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPemantauanMEOWS.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPemantauanEWSNeonatus.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnChecklistKriteriaMasukHCU.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnChecklistKriteriaKeluarHCU.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        BtnChecklistKriteriaKeluarHCU.setText("Check List Keluar HCU");
        BtnChecklistKriteriaKeluarHCU.setFocusPainted(false);
        BtnChecklistKriteriaKeluarHCU.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnChecklistKriteriaMasukICU.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnChecklistKriteriaKeluarICU.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        BtnChecklistKriteriaKeluarICU.setText("Check List Keluar ICU");
        BtnChecklistKriteriaKeluarICU.setFocusPainted(false);
        BtnChecklistKriteriaKeluarICU.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnMonitoringReaksiTranfusi.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnSkriningNutrisiDewasa.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnSkriningNutrisiLansia.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnSkriningNutrisiAnak.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnSkriningGiziLanjut.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnAsuhanGizi.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnMonitoringAsuhanGizi.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnCatatanADIMEGizi.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnKonselingFarmasi.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnInformasiObat.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnRekonsiliasiObat.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnTransferAntarRuang.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPengkajianRestrain.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPenilaianPasienTerminal.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPenilaianKorbanKekerasan.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPenilaianKecemasanAnak.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawaharah.png"))); // NOI18N
        BtnPenilaianKecemasanAnak.setText("Penilaian Kecemasan Anak");
        BtnPenilaianKecemasanAnak.setFocusPainted(false);
        BtnPenilaianKecemasanAnak.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPenilaianPasienPenyakitMenular.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPenilaianTambahanGeriatri.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPenilaianTambahanBunuhDiri.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPenilaianTambahanPerilakuKekerasan.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
        ...
        BtnPenilaianTambahanMelarikanDiri.setFont(new java.awt.Font("Liberation Sans", 0, 11)); // NOI18N
                    ...
                    if ((!TKeluhan.getText().trim().equals("")) || (!TPemeriksaan.getText().trim().equals("")) || (!TSuhu.getText().trim().equals(""))
                        ...
                        if (KdPeg.getText().trim().equals("") || TPegawai.getText().trim().equals("")) {
                            ...
                            if (akses.getkode().equals("Admin Utama")) {
                                if (Sequel.menyimpantf("pemeriksaan_ranap", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 21, new String[]{
                                    ...
                                    TPenilaian.getText(), TindakLanjut.getText(), TInstruksi.getText(), TEvaluasi.getText(), KdPeg.getText(), Status.getSelectedItem().toString()
                                }) == true) {
                                    tabModePemeriksaan.addRow(new Object[]{
                                        ...
                                        Jabatan.getText(), Status.getSelectedItem().toString()
                                    });
                                ...
                                if (akses.getkode().equals(KdPeg.getText())) {
                                    if (Sequel.menyimpantf("pemeriksaan_ranap", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 21, new String[]{
                                        ...
                                        LCount.setText("" + tabModePemeriksaan.getRowCount());
                                        BtnBatalActionPerformed(evt);
//                                        JOptionPane.showMessageDialog(null, "SOAP Berhasil di Simpan.");
                                    }
                                } else {
...
//        }
    ...
    private void BtnRwytLabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRwytLabActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu pasien...!!!");
            TCari.requestFocus();
        } else {
    ...
    }//GEN-LAST:event_BtnRwytLabActionPerformed
    ...
    private void BtnVerifSbar4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnVerifSbar4ActionPerformed
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
    ...
    }//GEN-LAST:event_BtnVerifSbar4ActionPerformed
    ...
    private void BtnStatsVerifikasiSoapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnStatsVerifikasiSoapActionPerformed
        if(TNoRw.getText().trim().equals("") ){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
    ...
    }//GEN-LAST:event_BtnStatsVerifikasiSoapActionPerformed
 ...
 // Pastikan Anda memiliki komponen JTextField bernama TNoRM di form Anda
    ...
    private void BtnHasilPengobatan3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHasilPengobatan3ActionPerformed
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
    ...
    }//GEN-LAST:event_BtnHasilPengobatan3ActionPerformed

    private void BtnBalanceCairan2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBalanceCairan2ActionPerformed
grafikttv ttv = new grafikttv("Grafik Tanda dan Objek Vital " + TPasien.getText() + "", "where catatan_observasi_ranap.no_rawat= '" + TNoRw.getText().toString() + "' ", TNoRw.getText().replaceAll("/", ""));
        ttv.setSize(internalFrame1.getWidth() - 100, internalFrame1.getHeight() - 100);
        ttv.setModal(true);
        ttv.setAlwaysOnTop(true);
        ttv.setLocationRelativeTo(internalFrame1);
        ttv.setVisible(true);
    }//GEN-LAST:event_BtnBalanceCairan2ActionPerformed

    private void BtnBalanceCairan3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBalanceCairan3ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnBalanceCairan3ActionPerformed
    ...
    private void BtnBalanceCairan5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBalanceCairan5ActionPerformed
        if (TPasien.getText().trim().equals("") || TNoRM.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            HandOver form = new HandOver(null, false);
            form.isCek();
            form.emptTeks();
            form.setNoRm(TNoRM.getText(), DTPCari2.getDate());
            form.tampil();
            form.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    }//GEN-LAST:event_BtnBalanceCairan5ActionPerformed
...
//this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
//ValidasiSBARModern form = new ValidasiSBARModern(null, false);
//form.isCek();
//form.emptTeks();
//form.setNoRm(TNoRw.getText(), DTPCari2.getDate());
//form.tampil();
...
//this.setCursor(Cursor.getDefaultCursor());
    ...
    private widget.Button BtnBalanceCairan2;
    private widget.Button BtnBalanceCairan3;
    private widget.Button BtnBalanceCairan5;
    ...
    private widget.Button BtnHasilPengobatan3;
    ...
    private widget.Button BtnRwytLab;
    ...
    private widget.Button BtnStatsVerifikasiSoap;
    ...
    private void isForm() {
        if (ChkInput.isSelected() == true) {
            ...
            PanelInput1.setPreferredSize(new Dimension(WIDTH, 380));
            panelGlass12.setVisible(true);
            ChkInput.setVisible(true);
        } else if (ChkInput.isSelected() == false) {
            ChkInput.setVisible(false);
            PanelInput1.setPreferredSize(new Dimension(WIDTH, 400));//[44, 134]
    ...
    private void tampilPemeriksaan() {
        ...
        try {
            ps4 = koneksi.prepareStatement("select pemeriksaan_ranap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"
                    ...
                    + "pemeriksaan_ranap.berat,pemeriksaan_ranap.spo2,pemeriksaan_ranap.gcs,pemeriksaan_ranap.kesadaran,pemeriksaan_ranap.keluhan, "
                    + "pemeriksaan_ranap.pemeriksaan,pemeriksaan_ranap.alergi,pemeriksaan_ranap.penilaian,pemeriksaan_ranap.rtl,"
                    + "pemeriksaan_ranap.instruksi,pemeriksaan_ranap.evaluasi,pemeriksaan_ranap.nip,pegawai.nama,pegawai.jbtn,pemeriksaan_ranap.status "
                    + "from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                    + "inner join pemeriksaan_ranap on pemeriksaan_ranap.no_rawat=reg_periksa.no_rawat "
                    + "inner join pegawai on pemeriksaan_ranap.nip=pegawai.nik where "
    ...
    private void getDataPemeriksaan() {
        if (tbPemeriksaan.getSelectedRow() != -1) {
            ...
            Status.setSelectedItem(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(), 22).toString());
        }
    }
