...
public final class BPJSCekReferensiDokterDPJP extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnPropinsi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawahpaper.png"))); // NOI18N
        BtnPropinsi.setMnemonic('3');
        BtnPropinsi.setToolTipText("ALt+3");
        BtnPropinsi.setGlassColor(new java.awt.Color(255, 255, 255));
