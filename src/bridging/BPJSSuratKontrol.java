...
public class BPJSSuratKontrol extends javax.swing.JDialog {
    ...
    public BPJSSuratKontrol(java.awt.Frame parent, boolean modal) {
        ...
        NoHpWA.setDocument(new batasInput((byte)20).getOnlyAngka(NoHpWA));
    ...
    private void initComponents() {
        ...
        UploadKontrol = new javax.swing.JMenuItem();
        KirimWAPasien = new javax.swing.JMenuItem();
        ...
        UploadKontrol.setBackground(new java.awt.Color(255, 255, 254));
        UploadKontrol.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        UploadKontrol.setForeground(new java.awt.Color(50, 50, 50));
        UploadKontrol.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        UploadKontrol.setText("Upload Surat Kontrol");
        UploadKontrol.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        UploadKontrol.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        UploadKontrol.setName("UploadKontrol"); // NOI18N
        UploadKontrol.setPreferredSize(new java.awt.Dimension(160, 26));
        UploadKontrol.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                UploadKontrolActionPerformed(evt);
            }
        });
        jPopupMenu1.add(UploadKontrol);

        KirimWAPasien.setBackground(new java.awt.Color(255, 255, 254));
        KirimWAPasien.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        KirimWAPasien.setForeground(new java.awt.Color(50, 50, 50));
        KirimWAPasien.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        KirimWAPasien.setText("Kirim WA Surat Kontrol");
        KirimWAPasien.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        KirimWAPasien.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        KirimWAPasien.setName("KirimWAPasien"); // NOI18N
        KirimWAPasien.setPreferredSize(new java.awt.Dimension(180, 26));
        KirimWAPasien.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                KirimWAPasienActionPerformed(evt);
            }
        });
        jPopupMenu1.add(KirimWAPasien);
        ...
        DTPTanggalSurat1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-01-2026" }));
        ...
        DTPTanggalSurat2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-01-2026" }));
        ...
        DTPTanggalKontrol1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-01-2026" }));
        ...
        DTPTanggalKontrol2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-01-2026" }));
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(190, 156));
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-01-2026" }));
        ...
        BtnDokter.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/20paper.png"))); // NOI18N
        ...
        BtnPoli.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/20paper.png"))); // NOI18N
        ...
        TanggalKontrol.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-01-2026 15:15:55" }));
        ...
        jLabel19.setText("No. WA :");
        jLabel19.setName("jLabel19"); // NOI18N
        FormInput.add(jLabel19);
        jLabel19.setBounds(0, 130, 90, 23);

        NoHpWA.setName("NoHpWA"); // NOI18N
        NoHpWA.setToolTipText("Isi untuk override nomor tujuan WA");
        FormInput.add(NoHpWA);
        NoHpWA.setBounds(94, 130, 250, 23);
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void UploadKontrolActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UploadKontrolActionPerformed
        if (tbObat.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(null, "Silakan pilih data Surat Kontrol yang akan diproses.");
            return;
        }

        // Ambil no_rawat dari kolom 0 (bukan 1)
        String noRawat = tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString().trim();

        // Cek apakah no_rawat valid di reg_periksa
        if (Sequel.cariInteger("SELECT COUNT(no_rawat) FROM reg_periksa WHERE no_rawat=?", noRawat) == 0) {
            JOptionPane.showMessageDialog(null, "Gagal membuat Surat Kontrol: No. Rawat tidak ditemukan di reg_periksa!", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        int selectedRow = tbObat.getSelectedRow();
        FileName = buildSuratKontrolFileName(selectedRow);
        if (FileName.isEmpty()) {
            return;
        }

        if (CreatePDF(FileName, selectedRow, true)) {
            UploadPDF(FileName, "pages/upload/", selectedRow, true);  // Pastikan docpath ini sesuai dengan upload.php
        }
        HapusPDF();

    }//GEN-LAST:event_UploadKontrolActionPerformed

    private void KirimWAPasienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KirimWAPasienActionPerformed
        int[] selectedRows = tbObat.getSelectedRows();
        if (selectedRows == null || selectedRows.length == 0) {
            JOptionPane.showMessageDialog(null, "Silakan pilih data Surat Kontrol yang akan dikirim.");
            return;
        }

        String waGateway = koneksiDB.WAGATEWAY();
        boolean useWaha = "waha".equalsIgnoreCase(waGateway);
        boolean useGolang = "golang".equalsIgnoreCase(waGateway) || "wagolang".equalsIgnoreCase(waGateway);
        if (!useWaha && !useGolang) {
            JOptionPane.showMessageDialog(null, "Gateway WhatsApp belum diset.", "Peringatan", JOptionPane.WARNING_MESSAGE);
            return;
        }

        boolean bulk = selectedRows.length > 1;
        int sukses = 0;
        int gagal = 0;
        int dilewati = 0;
        ...
        try {
            for (int row : selectedRows) {
                ...
                try {
                    String noRawat = tbObat.getValueAt(row, 0).toString().trim();
                    if (noRawat.isEmpty()) {
                        gagal++;
                        continue;
                    }
                    if (Sequel.cariInteger("SELECT COUNT(no_rawat) FROM reg_periksa WHERE no_rawat=?", noRawat) == 0) {
                        if (!bulk) {
                            JOptionPane.showMessageDialog(null, "No. Rawat tidak ditemukan di reg_periksa!", "Error", JOptionPane.ERROR_MESSAGE);
                        }
                        gagal++;
                        continue;
                    }

                    String noWa = resolveManualWaTarget(
                            Sequel.cariIsi(
                                    "select pasien.no_tlp from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis where reg_periksa.no_rawat=?",
                                    noRawat
                            )
                    );
                    if (noWa.isEmpty()) {
                        if (!bulk) {
                            JOptionPane.showMessageDialog(null, "No. HP pasien kosong, pengiriman dilewati.", "Peringatan", JOptionPane.WARNING_MESSAGE);
                        }
                        dilewati++;
                        continue;
                    }

                    String fileName = buildSuratKontrolFileName(row);
                    if (fileName.isEmpty()) {
                        gagal++;
                        continue;
                    }

                    if (!CreatePDF(fileName, row, !bulk)) {
                        gagal++;
                        continue;
                    }
                    pdfReady = true;
                    ...
                    String fileUrl = "";
                    if (useWaha) {
                        String docPath = "pages/upload/";
                        if (!UploadPDF(fileName, docPath, row, !bulk)) {
                            gagal++;
                            continue;
                        }
                        fileUrl = buildSuratKontrolFileUrl(fileName, docPath);
                        if (fileUrl.isEmpty()) {
                            if (!bulk) {
                                JOptionPane.showMessageDialog(null, "URL file kosong.", "Peringatan", JOptionPane.WARNING_MESSAGE);
                            }
                            gagal++;
                            continue;
                        }
                    ...
                    String nama = tbObat.getValueAt(row, 4).toString();
                    String noRm = tbObat.getValueAt(row, 3).toString();
                    String noSurat = tbObat.getValueAt(row, 9).toString();
                    String tglKontrol = tbObat.getValueAt(row, 10).toString();
                    String nmPoli = tbObat.getValueAt(row, 14).toString();
                    String nmDokter = tbObat.getValueAt(row, 12).toString();

                    String pesan = buildSuratKontrolWaMessage(nama, noRm, noSurat, tglKontrol, nmPoli, nmDokter);
                    ...
                    String chatId = "";
                    if (useWaha) {
                        WahaClient.Result result = WahaClient.sendFile(noWa, fileUrl, pesan);
                        if (!result.ok) {
                            result = WahaClient.sendText(noWa, pesan + "\n\n" + fileUrl);
                        }
                        terkirim = result.ok;
                        ...
                        WagolangClient.Result result = WagolangClient.sendFileMultipart(noWa, filePath, pesan);
                        if (!result.ok) {
                            result = WagolangClient.sendText(noWa, pesan);
                        }
                        terkirim = result.ok;
                        messageId = result.messageId;
                        chatId = result.chatId;
                    ...
                    if (!terkirim) {
                        ...
                        logWaReport(messageId, noRm, noWa, "Kirim Surat Kontrol", chatId, simpanPesan);
                        if (!bulk) {
        ...
        if (bulk) {
            JOptionPane.showMessageDialog(null,
                    "Selesai kirim WA Surat Kontrol.\nBerhasil: " + sukses + "\nGagal: " + gagal + "\nDilewati (No. HP kosong): " + dilewati,
                    "Informasi",
                    JOptionPane.INFORMATION_MESSAGE);
        }
    }//GEN-LAST:event_KirimWAPasienActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem KirimWAPasien;
    ...
    private javax.swing.JMenuItem UploadKontrol;
 ...
 private boolean CreatePDF(String FileName, int row, boolean showDialog) {
    if (row < 0) {
        if (showDialog) {
            JOptionPane.showMessageDialog(null, "Silakan pilih data Surat Kontrol yang akan diUpload.");
            BtnBatal.requestFocus();
        }
        return false;
    }
    ...
    try {
        ...
        String noSurat = "";
        Object noSuratObj = tbObat.getValueAt(row, 9);
        if (noSuratObj != null) {
            noSurat = noSuratObj.toString().trim();
        }
        if (noSurat.isEmpty()) {
            if (showDialog) {
                JOptionPane.showMessageDialog(null, "No. Surat tidak boleh kosong!", "Peringatan", JOptionPane.WARNING_MESSAGE);
            }
            return false;
        }
        ...
        param.put("kontakrs", akses.getkontakrs());
        param.put("logo", Sequel.cariGambar("select gambar.bpjs from gambar"));
        param.put("parameter", tbObat.getValueAt(row, 0).toString());

        String finger = "Dikeluarkan di " + akses.getnamars() + ", Kabupaten/Kota " + akses.getkabupatenrs()
                + "\nDitandatangani secara elektronik oleh " + tbObat.getValueAt(row, 11).toString()
                + "\nID " + tbObat.getValueAt(row, 10).toString()
                + "\n" + Valid.SetTgl3(tbObat.getValueAt(row, 7).toString());
        ...
        return new File("tmpPDF/" + FileName + ".pdf").exists();
    } catch (Exception e) {
        if (showDialog) {
            JOptionPane.showMessageDialog(null, "Gagal membuat laporan: " + e.getMessage(), "Kesalahan", JOptionPane.ERROR_MESSAGE);
        }
        e.printStackTrace();
        return false;
    } finally {
   ...
   private boolean UploadPDF(String FileName, String docpath, int row, boolean showDialog) {
        try {
            File file = new File("tmpPDF/" + FileName + ".pdf");

            if (!file.exists()) {
                if (showDialog) {
                    JOptionPane.showMessageDialog(null, "File PDF tidak ditemukan: " + file.getAbsolutePath(), "Kesalahan", JOptionPane.ERROR_MESSAGE);
                }
                return false;
            }
            ...
            if (row < 0) {
                if (showDialog) {
                    JOptionPane.showMessageDialog(null, "No. Rawat tidak ditemukan.", "Peringatan", JOptionPane.WARNING_MESSAGE);
                }
                return false;
            }

            String no_rawat = tbObat.getValueAt(row, 0).toString().trim();
            if (Sequel.cariInteger("SELECT COUNT(no_rawat) FROM reg_periksa WHERE no_rawat=?", no_rawat) == 0) {
                if (showDialog) {
                    JOptionPane.showMessageDialog(null, "No. Rawat tidak ditemukan di reg_periksa. Gagal menyimpan ke database.", "Peringatan", JOptionPane.WARNING_MESSAGE);
                }
                return false;
            }

            String lokasiFile = docpath + FileName + ".pdf";
            String kodeberkas = Sequel.cariIsi("SELECT kode FROM master_berkas_digital WHERE nama LIKE '%KARTU KONTROL%'");
    ...
    private String buildSuratKontrolFileName(int row) {
        if (row < 0) {
            return "";
        }
        String noRawat = tbObat.getValueAt(row, 0).toString().replaceAll("/", "");
        String noSep = tbObat.getValueAt(row, 1).toString();
        String noRm = tbObat.getValueAt(row, 3).toString();
        return "KONTROL_" + noRawat + "_" + noSep + "_" + noRm;
    }

    private String buildSuratKontrolFileName() {
        return buildSuratKontrolFileName(tbObat.getSelectedRow());
    }

    private String buildSuratKontrolFileUrl(String fileName, String docpath) {
        ...
        return "http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.PORTWEB() + "/" + koneksiDB.HYBRIDWEB() + "/" + path + fileName + ".pdf";
    }

    private String buildSuratKontrolWaMessage(String nama, String noRm, String noSurat, String tglKontrol, String nmPoli, String nmDokter) {
        ...
        pesan.append("\n\n\uD83D\uDCC4 SURAT KONTROL BPJS VClaim");
        pesan.append("\n\uD83D\uDC64 NAMA : ").append(safeDash(nama));
        ...
        pesan.append("\nSilakan ambil antrian melalui Aplikasi Mobile JKN untuk pendaftaran.");
        return pesan.toString();
    }

    private String resolveManualWaTarget(String fallback) {
        String manual = NoHpWA == null ? "" : NoHpWA.getText();
        if (manual != null) {
            manual = manual.trim().replace("|", "").replace(" ", "");
        }
        if (manual != null && !manual.isEmpty()) {
            if (manual.contains("@")) {
                return manual;
            }
            return manual.replaceAll("[^0-9]", "");
        }
        if (fallback == null) {
            return "";
        }
        return fallback.trim().replace("|", "").replace(" ", "");
    }
    ...
    private void logWaReport(String messageId, String noRm, String noWa, String aktivitas, String chatId, String pesan) {
        LocalDateTime now = LocalDateTime.now();
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
        String dateNow = now.format(formatter);
        String safeMessageId = messageId == null ? "" : messageId;
        String safeChatId = chatId == null ? "" : chatId;
        String safePesan = pesan == null ? "" : pesan;
        Sequel.queryu("INSERT INTO wa_report VALUES ('" + safeMessageId + "', '" + noRm + "', '" + noWa + "', '" + akses.getkode() + "', '" + aktivitas + "', '" + safeChatId + "', '" + safePesan + "', '', 'true', '', '" + dateNow + "', '" + dateNow + "')");
    }
