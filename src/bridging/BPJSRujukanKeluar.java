...
public final class BPJSRujukanKeluar extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnPPKRujukan1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawahpaper.png"))); // NOI18N
        btnPPKRujukan1.setMnemonic('X');
        btnPPKRujukan1.setToolTipText("Alt+X");
        btnPPKRujukan1.setGlassColor(new java.awt.Color(255, 255, 255));
        ...
        btnDiagnosa1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawahpaper.png"))); // NOI18N
        btnDiagnosa1.setMnemonic('X');
        btnDiagnosa1.setToolTipText("Alt+X");
        btnDiagnosa1.setGlassColor(new java.awt.Color(255, 255, 255));
