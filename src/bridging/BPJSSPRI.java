...
public class BPJSSPRI extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnSurat1.setText("Upload SPRI ke Berkas Digital");
        ...
        DTPTanggalSurat1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-11-2024" }));
        ...
        DTPTanggalSurat2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-11-2024" }));
        ...
        DTPTanggalKontrol1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-11-2024" }));
        ...
        DTPTanggalKontrol2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-11-2024" }));
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-11-2024" }));
        ...
        BtnPoli.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawahpaper.png"))); // NOI18N
        ...
        TanggalKontrol.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-11-2024" }));
        ...
        btnDiagnosa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawahpaper.png"))); // NOI18N
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
    ...
    private void MnSurat1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSurat1ActionPerformed
        ...
        // Format nama file
        FileName = "SPRI_"
                + tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString().replaceAll("/", "") // no_rawat
                + "_" + tbObat.getValueAt(tbObat.getSelectedRow(), 1).toString() // no_kartu
                + "_" + tbObat.getValueAt(tbObat.getSelectedRow(), 3).toString();              // nama pasien

        CreatePDF(FileName);
        UploadPDF(FileName, "pages/upload/");  // Pastikan docpath ini sesuai dengan upload.php
        HapusPDF();
   ...
   private void CreatePDF(String FileName) {
    if (tbObat.getSelectedRow() == -1) {
        JOptionPane.showMessageDialog(null, "Silakan pilih data Surat PRI yang akan dicetak.");
        BtnBatal.requestFocus();
        return;
    }
    ...
    try {
        ...
        // Query SQL yang benar dan aman
        String query = "SELECT bridging_surat_pri_bpjs.no_rawat, bridging_surat_pri_bpjs.no_kartu, reg_periksa.no_rkm_medis, " +
                "pasien.nm_pasien, pasien.tgl_lahir, pasien.jk, bridging_surat_pri_bpjs.diagnosa, " +
                "bridging_surat_pri_bpjs.tgl_surat, bridging_surat_pri_bpjs.no_surat, bridging_surat_pri_bpjs.tgl_rencana, " +
                "bridging_surat_pri_bpjs.kd_dokter_bpjs, bridging_surat_pri_bpjs.nm_dokter_bpjs, " +
                "bridging_surat_pri_bpjs.kd_poli_bpjs, bridging_surat_pri_bpjs.nm_poli_bpjs " +
                "FROM reg_periksa " +
        ...
        Valid.MyReportPDFqryUpload("rptBridgingSuratPRI2.jasper", "report", "::[ Data Surat PRI VClaim ]::", query, FileName, param);
    ...
    private void UploadPDF(String FileName, String docpath) {
        try {
            ...
            String kodeberkas = Sequel.cariIsi("SELECT kode FROM master_berkas_digital WHERE nama LIKE '%SPRI%'");
