...
public final class ApotekBPJSDaftarResepObat extends javax.swing.JDialog {
    ...
    private String kolomNoResepHeader="no_resep",kolomNoResepRacikan="no_resep",kolomNoResepNonRacikan="no_resep";
    ...
    private String ambilKolomNoResep(String namaTabel){
        if(Sequel.cariInteger("select count(*) from information_schema.columns where table_schema='"+koneksiDB.DATABASE()+"' and table_name='"+namaTabel+"' and column_name='no_resep'")>0){
            return "no_resep";
        }else if(Sequel.cariInteger("select count(*) from information_schema.columns where table_schema='"+koneksiDB.DATABASE()+"' and table_name='"+namaTabel+"' and column_name='noresep'")>0){
            return "noresep";
        }else{
            return "no_resep";
        }
    ...
    private void sinkronKolomNoResep(){
        kolomNoResepHeader=ambilKolomNoResep("bridging_resep_apotek_bpjs");
        kolomNoResepRacikan=ambilKolomNoResep("bridging_resep_apotek_bpjs_racikan");
        kolomNoResepNonRacikan=ambilKolomNoResep("bridging_resep_apotek_bpjs_nonracikan");
    }
            ...
            if(ChkAccor.isSelected()==true){
                ...
                try {
                    ps=koneksi.prepareStatement(
                        ...
                        "where bridging_resep_apotek_bpjs_racikan.no_sep_apotek=? and bridging_resep_apotek_bpjs_racikan."+kolomNoResepRacikan+"=?"
                    );
                    try {
                ...
                try {
                    ps=koneksi.prepareStatement(
                        ...
                        "where bridging_resep_apotek_bpjs_nonracikan.no_sep_apotek=? and bridging_resep_apotek_bpjs_nonracikan."+kolomNoResepNonRacikan+"=?"
                    );
                    try {
                        ps.setString(1,tbResep.getValueAt(tbResep.getSelectedRow(),1).toString());
                        ps.setString(2,tbResep.getValueAt(tbResep.getSelectedRow(),9).toString());
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                ...
                "bridging_sep.no_kartu,bridging_resep_apotek_bpjs.kdjenis,bridging_resep_apotek_bpjs.id_user_sep,bridging_resep_apotek_bpjs."+kolomNoResepHeader+" as no_resep,bridging_resep_apotek_bpjs.tgl_resep,"+
                ...
                "bridging_sep.nomr like ? or bridging_resep_apotek_bpjs.kdjenis like ? or bridging_resep_apotek_bpjs."+kolomNoResepHeader+" like ? or bridging_resep_apotek_bpjs.id_user_sep like ?)")
            );
            try {
    ...
    private void tampil2() {
        ...
        try{
            ps=koneksi.prepareStatement(
                ...
                "bridging_resep_apotek_bpjs."+kolomNoResepHeader+" like ? or bridging_resep_apotek_bpjs.id_user_sep like ? or bridging_resep_apotek_bpjs_racikan.kode_brng_apotek_bpjs like ? or "+
            ...
            ps=koneksi.prepareStatement(
                ...
                "where bridging_resep_apotek_bpjs.tgl_resep between ? and ? "+(TCari.getText().trim().equals("")?"":"and (bridging_resep_apotek_bpjs.no_sep like ? or "+
                "bridging_resep_apotek_bpjs.no_sep_apotek like ? or bridging_sep.no_rawat like ? or bridging_sep.nomr like ? or bridging_resep_apotek_bpjs.kdjenis like ? or "+
                "bridging_resep_apotek_bpjs."+kolomNoResepHeader+" like ? or bridging_resep_apotek_bpjs.id_user_sep like ? or bridging_resep_apotek_bpjs_nonracikan.kode_brng_apotek_bpjs like ? or "+
                "maping_obat_apotek_bpjs.nama_brng_apotek_bpjs like ?)")
            );
            try {
                ps.setString(1,Valid.SetTglJam(DTPCari1.getSelectedItem()+" 00:00:01"));
