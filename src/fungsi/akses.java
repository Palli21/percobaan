...
public final class akses {
    ...
    private static String kode="",kdbangsal="",alamatip="",namars="",alamatrs="",kabupatenrs="",propinsirs="",kontakrs="",emailrs="",form="",namauser="",kode_ppk="", CopyData = "",CopyData1 = "", CopyData2 = "", CopyData3 = "", CopyData4 = "", CopyData5 = "";
    ...
    private static boolean aktif=false,admin=false,user=false,vakum=false,aplikasi=false,penyakit=false,obat_penyakit=false,dokter=false,jadwal_praktek=false,petugas=false,pasien=false,registrasi=false,
            ...
            balance_cairan=false,catatan_observasi_chbp=false,Konsultasi_medik=false,jawaban_Konsultasi_medik=false;
    private static boolean konsultasi_medik;
    private static boolean jawaban_konsultasi_medik;
    ...
    public static void setCopyData(String datanya) {akses.CopyData = datanya;}      //MODIF
    public static void setCopyData1(String datanya1) {akses.CopyData1 = datanya1;}
    public static void setCopyData2(String datanya2) {akses.CopyData2 = datanya2;}
    public static void setCopyData3(String datanya3) {akses.CopyData3 = datanya3;}
    public static void setCopyData4(String datanya4) {akses.CopyData4 = datanya4;}
    public static void setCopyData5(String datanya5) {akses.CopyData5 = datanya5;}  //SAMPAI SINI
