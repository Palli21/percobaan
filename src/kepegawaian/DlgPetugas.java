...
public final class DlgPetugas extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnJabatan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawahpaper.png"))); // NOI18N
        btnJabatan.setMnemonic('1');
        btnJabatan.setToolTipText("ALt+1");
        btnJabatan.setGlassColor(new java.awt.Color(255, 255, 255));
        ...
        BtnCariPegawai.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bawahpaper.png"))); // NOI18N
        BtnCariPegawai.setMnemonic('1');
        BtnCariPegawai.setToolTipText("ALt+1");
        BtnCariPegawai.setGlassColor(new java.awt.Color(255, 255, 255));
        ...
        FormInput.add(Email);
        Email.setBounds(700, 70, 190, 23);

        jLabel23.setText("Email :");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(650, 70, 50, 23);
