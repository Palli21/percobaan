...
/**
 * TextBox2 yang mengikuti font sesuai dengan sistem operasi (Windows atau Mac),
...
public class TextBox2 extends TextBoxGlass {
    ...
    public TextBox2() {
        ...
        setFocusable(true); // TextBox2 dapat difokuskan
        addFocusListener(new FocusListener() {
            @Override
            public void focusGained(FocusEvent e) {
                isHovered = true; // Ketika TextBox2 disentuh
                repaint(); // Gambar ulang agar perubahan terlihat
            }

            @Override
            public void focusLost(FocusEvent e) {
                isHovered = false; // Ketika TextBox2 tidak disentuh lagi
    ...
    protected void paintComponent(Graphics g) {
        ...
        // Warna border bergantung pada apakah mouse sedang menyentuh TextBox2
        ...
        super.
                paintComponent(g); // Ini hanya mengatur teks, kursor, dan highlight
    }
